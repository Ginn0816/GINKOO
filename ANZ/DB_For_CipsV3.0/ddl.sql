...
--CIPS_112_REMIT的备份和创建
create table CIPS_112_REMIT_BAK202605 as select * from CIPS_112_REMIT;

drop table CIPS_112_REMIT;

-- auto-generated definition
create table CIPS_112_REMIT
(
    SEQ_NO                  CHAR(20) not null
        constraint CIPS_112_REMIT_PK
            primary key,
    CORP_ID                 VARCHAR2(20),
    TXN_SEQ_NO              CHAR(20) not null,
    ORI_SEQ_NO              CHAR(20),
    ...
    DBTR_CLR_SYS            VARCHAR2(5),
    DBTR_CLR_SYSX           VARCHAR2(35),
    DBTR_CLR_SYS_MMBID      VARCHAR2(35),
    DBTR_LEI                VARCHAR2(20),
    DBTR_NAME               VARCHAR2(420),
    DBTR_ADR_DEPT           VARCHAR2(210),
    DBTR_ADR_SDEPT          VARCHAR2(210),
    DBTR_ADR_STRT_NM        VARCHAR2(210),
    ...
    CDTR_AGT_AC_AKA_ID_TPX  VARCHAR2(35),
    CDTR_AGT_AC_AKA_ID      VARCHAR2(2048),
    CDTR_BIC                VARCHAR2(11),
    CDTR_CLR_SYS            VARCHAR2(5),
    CDTR_CLR_SYSX           VARCHAR2(35),
    CDTR_CLR_SYS_MMBID      VARCHAR2(35),
    CDTR_LEI                VARCHAR2(20),
    CDTR_NAME               VARCHAR2(420),
    CDTR_ADR_DEPT           VARCHAR2(210),
    CDTR_ADR_SDEPT          VARCHAR2(210),
    CDTR_ADR_STRT_NM        VARCHAR2(210),
...
comment on column CIPS_112_REMIT.SEQ_NO is '序号'
/

comment on column CIPS_112_REMIT.CORP_ID is '法人ID'
/

comment on column CIPS_112_REMIT.TXN_SEQ_NO is '业务表关联序号'
/

comment on column CIPS_112_REMIT.ORI_SEQ_NO is '关联接口表序号'
/

comment on column CIPS_112_REMIT.TXN_DIR is '来往账方向'
/

comment on column CIPS_112_REMIT.SND_ST_BRNO is '发起直接参与机构'
/

comment on column CIPS_112_REMIT.SND_ST_BRNAME is '发起直接参与机构名'
/

comment on column CIPS_112_REMIT.RCV_ST_BRNO is '接收直接参与机构'
/

comment on column CIPS_112_REMIT.RCV_ST_BRNAME is '接收直接参与机构名'
/

comment on column CIPS_112_REMIT.SYS_CODE is '系统类别'
/

comment on column CIPS_112_REMIT.SRC_SYS is '发送系统号'
/

comment on column CIPS_112_REMIT.DEST_SYS is '接收系统号'
/

comment on column CIPS_112_REMIT.MSG_TYPE is '报文号'
/

comment on column CIPS_112_REMIT.MSG_SND_TIME is '报文发送时间'
/

comment on column CIPS_112_REMIT.MSG_PRIO is '报文优先级'
/

comment on column CIPS_112_REMIT.MSG_ID is '报文标识号'
/

comment on column CIPS_112_REMIT.WORK_DATE is '工作日期'
/

comment on column CIPS_112_REMIT.COMM_STATUS is '通讯状态'
/

comment on column CIPS_112_REMIT.PBOC_STATUS is '人行状态'
/

comment on column CIPS_112_REMIT.CRE_DT_TM is '报文发送时间'
/

comment on column CIPS_112_REMIT.NB_OF_TXS is '交易笔数'
/

comment on column CIPS_112_REMIT.STTLM_MTD is '结算方式'
/

comment on column CIPS_112_REMIT.INSTR_ID is '指令标识号'
/

comment on column CIPS_112_REMIT.END_TO_END_ID is '端到端标识号'
/
comment on column CIPS_112_REMIT.TX_ID is '交易标识号'
/

comment on column CIPS_112_REMIT.UETR is 'UETR'
/
comment on column CIPS_112_REMIT.CLR_SYS_REF is '系统追踪标识号'
/

comment on column CIPS_112_REMIT.SVC_LVL1 is '服务级别1'
/
comment on column CIPS_112_REMIT.SVC_LVL2 is '服务级别2'
/
comment on column CIPS_112_REMIT.SVC_LVL3 is '服务级别3'
/
comment on column CIPS_112_REMIT.SVC_LVLX1 is '服务级别Proprietary1'
/
comment on column CIPS_112_REMIT.SVC_LVLX2 is '服务级别Proprietary2'
/

comment on column CIPS_112_REMIT.SVC_LVLX3 is '服务级别Proprietary3'
/
comment on column CIPS_112_REMIT.CTGY_PURP is '业务种类编码'
/

comment on column CIPS_112_REMIT.CTGY_PURPX is '业务种类Proprietary'
/
comment on column CIPS_112_REMIT.AMT_CURCD is '币种'
/

comment on column CIPS_112_REMIT.AMT is '金额'
/

comment on column CIPS_112_REMIT.INTR_BK_STTLM_DT is '银行间结算日期'
/
comment on column CIPS_112_REMIT.STTLM_PRTY is '业务优先级'
/
comment on column CIPS_112_REMIT.DBT_DT_TM is '借记时间'
/

comment on column CIPS_112_REMIT.CDT_DT_TM is '贷记时间'
/

comment on column CIPS_112_REMIT.PRE_AGT1_BIC is '前序机构1_BIC码'
/

comment on column CIPS_112_REMIT.PRE_AGT1_CLR_SYS is '前序机构1_清算系统标识（代码）'
/
comment on column CIPS_112_REMIT.PRE_AGT1_CLR_SYSX is '前序机构1_清算系统标识（自定义内容）'
/
comment on column CIPS_112_REMIT.PRE_AGT1_CLR_SYS_MMBID is '前序机构1_参与者身份标识'
/
comment on column CIPS_112_REMIT.PRE_AGT1_LEI is '前序机构1_LEI码'
/

comment on column CIPS_112_REMIT.PRE_AGT1_NAME is '前序机构1_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_DEPT is '前序机构1_地址_部门'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_SDEPT is '前序机构1_地址_分部'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_STRT_NM is '前序机构1_地址_街道名称'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_BLDG_NB is '前序机构1_地址_建筑编号'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_BLDG_NM is '前序机构1_地址_建筑名称'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_FLR is '前序机构1_地址_建筑楼层'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_PST_BX is '前序机构1_地址_邮政信箱'
/
comment on column CIPS_112_REMIT.PRE_AGT1_ADR_ROOM is '前序机构1_地址_房间号'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_PST_CD is '前序机构1_地址_邮政编码'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_TWN is '前序机构1_地址_城镇名称'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_TWN_LOC is '前序机构1_地址_城镇地址'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_DSTRCT is '前序机构1_地址_地区名称'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_AREA is '前序机构1_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_CTRY is '前序机构1_地址_国家'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_ADR_LINE1 is '前序机构1_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ADR_ADR_LINE2 is '前序机构1_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ID is '前序机构1_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT1_ID_SCHEX is '前序机构1_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_IBAN is '前序机构1账户_IBAN码'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_ID is '前序机构1账户_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_ID_SCHE is '前序机构1账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_ID_SCHEX is '前序机构1账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_ID_ISSR is '前序机构1账户_发码方'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_TYPE is '前序机构1账户_类型代码'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_TYPEX is '前序机构1账户_用途说明'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_CCY is '前序机构1账户_币种'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_NAME is '前序机构1账户_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_AKA_ID_TP is '前序机构1账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_AKA_ID_TPX is '前序机构1账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT1_AC_AKA_ID is '前序机构1账户_账户别名'
/

comment on column CIPS_112_REMIT.PRE_AGT2_BIC is '前序机构2_BIC码'
/

comment on column CIPS_112_REMIT.PRE_AGT2_CLR_SYS is '前序机构2_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_CLR_SYSX is '前序机构2_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_CLR_SYS_MMBID is '前序机构2_参与者身份标识'
/

comment on column CIPS_112_REMIT.PRE_AGT2_LEI is '前序机构2_LEI码'
/

comment on column CIPS_112_REMIT.PRE_AGT2_NAME is '前序机构2_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_DEPT is '前序机构2_地址_部门'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_SDEPT is '前序机构2_地址_分部'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_STRT_NM is '前序机构2_地址_街道名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_BLDG_NB is '前序机构2_地址_建筑编号'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_BLDG_NM is '前序机构2_地址_建筑名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_FLR is '前序机构2_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_PST_BX is '前序机构2_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_ROOM is '前序机构2_地址_房间号'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_PST_CD is '前序机构2_地址_邮政编码'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_TWN is '前序机构2_地址_城镇名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_TWN_LOC is '前序机构2_地址_城镇地址'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_DSTRCT is '前序机构2_地址_地区名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_AREA is '前序机构2_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_CTRY is '前序机构2_地址_国家'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_ADR_LINE1 is '前序机构2_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ADR_ADR_LINE2 is '前序机构2_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ID is '前序机构2_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT2_ID_SCHEX is '前序机构2_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_IBAN is '前序机构2账户_IBAN码'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_ID is '前序机构2账户_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_ID_SCHE is '前序机构2账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_ID_SCHEX is '前序机构2账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_ID_ISSR is '前序机构2账户_发码方'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_TYPE is '前序机构2账户_类型代码'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_TYPEX is '前序机构2账户_用途说明'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_CCY is '前序机构2账户_币种'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_NAME is '前序机构2账户_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_AKA_ID_TP is '前序机构2账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_AKA_ID_TPX is '前序机构2账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT2_AC_AKA_ID is '前序机构2账户_账户别名'
/

comment on column CIPS_112_REMIT.PRE_AGT3_BIC is '前序机构3_BIC码'
/

comment on column CIPS_112_REMIT.PRE_AGT3_CLR_SYS is '前序机构3_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_CLR_SYSX is '前序机构3_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_CLR_SYS_MMBID is '前序机构3_参与者身份标识'
/

comment on column CIPS_112_REMIT.PRE_AGT3_LEI is '前序机构3_LEI码'
/

comment on column CIPS_112_REMIT.PRE_AGT3_NAME is '前序机构3_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_DEPT is '前序机构3_地址_部门'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_SDEPT is '前序机构3_地址_分部'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_STRT_NM is '前序机构3_地址_街道名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_BLDG_NB is '前序机构3_地址_建筑编号'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_BLDG_NM is '前序机构3_地址_建筑名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_FLR is '前序机构3_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_PST_BX is '前序机构3_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_ROOM is '前序机构3_地址_房间号'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_PST_CD is '前序机构3_地址_邮政编码'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_TWN is '前序机构3_地址_城镇名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_TWN_LOC is '前序机构3_地址_城镇地址'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_DSTRCT is '前序机构3_地址_地区名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_AREA is '前序机构3_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_CTRY is '前序机构3_地址_国家'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_ADR_LINE1 is '前序机构3_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ADR_ADR_LINE2 is '前序机构3_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ID is '前序机构3_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT3_ID_SCHEX is '前序机构3_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_IBAN is '前序机构3账户_IBAN码'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_ID is '前序机构3账户_账号'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_ID_SCHE is '前序机构3账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_ID_SCHEX is '前序机构3账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_ID_ISSR is '前序机构3账户_发码方'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_TYPE is '前序机构3账户_类型代码'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_TYPEX is '前序机构3账户_用途说明'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_CCY is '前序机构3账户_币种'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_NAME is '前序机构3账户_名称'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_AKA_ID_TP is '前序机构3账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_AKA_ID_TPX is '前序机构3账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.PRE_AGT3_AC_AKA_ID is '前序机构3账户_账户别名'
/

comment on column CIPS_112_REMIT.INSTG_AGT_BIC is '发报方_BIC码'
/

comment on column CIPS_112_REMIT.INSTG_AGT_CLR_SYS is '发报方_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.INSTG_AGT_CLR_SYS_MMBID is '发报方_参与者身份标识'
/

comment on column CIPS_112_REMIT.INSTG_AGT_LEI is '发报方_LEI码'
/

comment on column CIPS_112_REMIT.INSTD_AGT_BIC is '收报方_BIC码'
/

comment on column CIPS_112_REMIT.INSTD_AGT_CLR_SYS is '收报方_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.INSTD_AGT_CLR_SYS_MMBID is '收报方_参与者身份标识'
/

comment on column CIPS_112_REMIT.INSTD_AGT_LEI is '收报方_LEI码'
/

comment on column CIPS_112_REMIT.IM_AGT1_BIC is '中介机构1_BIC码'
/

comment on column CIPS_112_REMIT.IM_AGT1_CLR_SYS is '中介机构1_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT1_CLR_SYSX is '中介机构1_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT1_CLR_SYS_MMBID is '中介机构1_参与者身份标识'
/

comment on column CIPS_112_REMIT.IM_AGT1_LEI is '中介机构1_LEI码'
/

comment on column CIPS_112_REMIT.IM_AGT1_NAME is '中介机构1_名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_DEPT is '中介机构1_地址_部门'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_SDEPT is '中介机构1_地址_分部'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_STRT_NM is '中介机构1_地址_街道名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_BLDG_NB is '中介机构1_地址_建筑编号'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_BLDG_NM is '中介机构1_地址_建筑名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_FLR is '中介机构1_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_PST_BX is '中介机构1_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_ROOM is '中介机构1_地址_房间号'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_PST_CD is '中介机构1_地址_邮政编码'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_TWN is '中介机构1_地址_城镇名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_TWN_LOC is '中介机构1_地址_城镇地址'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_DSTRCT is '中介机构1_地址_地区名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_AREA is '中介机构1_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_CTRY is '中介机构1_地址_国家'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_ADR_LINE1 is '中介机构1_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.IM_AGT1_ADR_ADR_LINE2 is '中介机构1_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.IM_AGT1_ID is '中介机构1_账号'
/

comment on column CIPS_112_REMIT.IM_AGT1_ID_SCHEX is '中介机构1_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_IBAN is '中介机构1账户_IBAN码'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_ID is '中介机构1账户_账号'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_ID_SCHE is '中介机构1账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_ID_SCHEX is '中介机构1账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_ID_ISSR is '中介机构1账户_发码方'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_TYPE is '中介机构1账户_类型代码'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_TYPEX is '中介机构1账户_用途说明'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_CCY is '中介机构1账户_币种'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_NAME is '中介机构1账户_名称'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_AKA_ID_TP is '中介机构1账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_AKA_ID_TPX is '中介机构1账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT1_AC_AKA_ID is '中介机构1账户_账户别名'
/

comment on column CIPS_112_REMIT.IM_AGT2_BIC is '中介机构2_BIC码'
/

comment on column CIPS_112_REMIT.IM_AGT2_CLR_SYS is '中介机构2_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT2_CLR_SYSX is '中介机构2_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT2_CLR_SYS_MMBID is '中介机构2_参与者身份标识'
/

comment on column CIPS_112_REMIT.IM_AGT2_LEI is '中介机构2_LEI码'
/

comment on column CIPS_112_REMIT.IM_AGT2_NAME is '中介机构2_名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_DEPT is '中介机构2_地址_部门'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_SDEPT is '中介机构2_地址_分部'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_STRT_NM is '中介机构2_地址_街道名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_BLDG_NB is '中介机构2_地址_建筑编号'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_BLDG_NM is '中介机构2_地址_建筑名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_FLR is '中介机构2_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_PST_BX is '中介机构2_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_ROOM is '中介机构2_地址_房间号'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_PST_CD is '中介机构2_地址_邮政编码'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_TWN is '中介机构2_地址_城镇名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_TWN_LOC is '中介机构2_地址_城镇地址'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_DSTRCT is '中介机构2_地址_地区名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_AREA is '中介机构2_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_CTRY is '中介机构2_地址_国家'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_ADR_LINE1 is '中介机构2_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.IM_AGT2_ADR_ADR_LINE2 is '中介机构2_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.IM_AGT2_ID is '中介机构2_账号'
/

comment on column CIPS_112_REMIT.IM_AGT2_ID_SCHEX is '中介机构2_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_IBAN is '中介机构2账户_IBAN码'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_ID is '中介机构2账户_账号'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_ID_SCHE is '中介机构2账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_ID_SCHEX is '中介机构2账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_ID_ISSR is '中介机构2账户_发码方'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_TYPE is '中介机构2账户_类型代码'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_TYPEX is '中介机构2账户_用途说明'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_CCY is '中介机构2账户_币种'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_NAME is '中介机构2账户_名称'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_AKA_ID_TP is '中介机构2账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_AKA_ID_TPX is '中介机构2账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT2_AC_AKA_ID is '中介机构2账户_账户别名'
/

comment on column CIPS_112_REMIT.IM_AGT3_BIC is '中介机构3_BIC码'
/

comment on column CIPS_112_REMIT.IM_AGT3_CLR_SYS is '中介机构3_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT3_CLR_SYSX is '中介机构3_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT3_CLR_SYS_MMBID is '中介机构3_参与者身份标识'
/

comment on column CIPS_112_REMIT.IM_AGT3_LEI is '中介机构3_LEI码'
/

comment on column CIPS_112_REMIT.IM_AGT3_NAME is '中介机构3_名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_DEPT is '中介机构3_地址_部门'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_SDEPT is '中介机构3_地址_分部'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_STRT_NM is '中介机构3_地址_街道名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_BLDG_NB is '中介机构3_地址_建筑编号'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_BLDG_NM is '中介机构3_地址_建筑名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_FLR is '中介机构3_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_PST_BX is '中介机构3_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_ROOM is '中介机构3_地址_房间号'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_PST_CD is '中介机构3_地址_邮政编码'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_TWN is '中介机构3_地址_城镇名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_TWN_LOC is '中介机构3_地址_城镇地址'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_DSTRCT is '中介机构3_地址_地区名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_AREA is '中介机构3_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_CTRY is '中介机构3_地址_国家'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_ADR_LINE1 is '中介机构3_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.IM_AGT3_ADR_ADR_LINE2 is '中介机构3_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.IM_AGT3_ID is '中介机构3_账号'
/

comment on column CIPS_112_REMIT.IM_AGT3_ID_SCHEX is '中介机构3_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_IBAN is '中介机构3账户_IBAN码'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_ID is '中介机构3账户_账号'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_ID_SCHE is '中介机构3账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_ID_SCHEX is '中介机构3账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_ID_ISSR is '中介机构3账户_发码方'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_TYPE is '中介机构3账户_类型代码'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_TYPEX is '中介机构3账户_用途说明'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_CCY is '中介机构3账户_币种'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_NAME is '中介机构3账户_名称'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_AKA_ID_TP is '中介机构3账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_AKA_ID_TPX is '中介机构3账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.IM_AGT3_AC_AKA_ID is '中介机构3账户_账户别名'
/

comment on column CIPS_112_REMIT.DBTR_BIC is '付款行_BIC码'
/

comment on column CIPS_112_REMIT.DBTR_CLR_SYS is '付款行_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.DBTR_CLR_SYSX is '付款行_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_CLR_SYS_MMBID is '付款行_参与者身份标识'
/

comment on column CIPS_112_REMIT.DBTR_LEI is '付款行_LEI码'
/

comment on column CIPS_112_REMIT.DBTR_NAME is '付款行_名称'
/

comment on column CIPS_112_REMIT.DBTR_ADR_DEPT is '付款行_地址_部门'
/

comment on column CIPS_112_REMIT.DBTR_ADR_SDEPT is '付款行_地址_分部'
/

comment on column CIPS_112_REMIT.DBTR_ADR_STRT_NM is '付款行_地址_街道名称'
/

comment on column CIPS_112_REMIT.DBTR_ADR_BLDG_NB is '付款行_地址_建筑编号'
/

comment on column CIPS_112_REMIT.DBTR_ADR_BLDG_NM is '付款行_地址_建筑名称'
/

comment on column CIPS_112_REMIT.DBTR_ADR_FLR is '付款行_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.DBTR_ADR_PST_BX is '付款行_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.DBTR_ADR_ROOM is '付款行_地址_房间号'
/

comment on column CIPS_112_REMIT.DBTR_ADR_PST_CD is '付款行_地址_邮政编码'
/

comment on column CIPS_112_REMIT.DBTR_ADR_TWN is '付款行_地址_城镇名称'
/

comment on column CIPS_112_REMIT.DBTR_ADR_TWN_LOC is '付款行_地址_城镇地址'
/

comment on column CIPS_112_REMIT.DBTR_ADR_DSTRCT is '付款行_地址_地区名称'
/

comment on column CIPS_112_REMIT.DBTR_ADR_AREA is '付款行_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.DBTR_ADR_CTRY is '付款行_地址_国家'
/

comment on column CIPS_112_REMIT.DBTR_ADR_ADR_LINE1 is '付款行_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.DBTR_ADR_ADR_LINE2 is '付款行_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.DBTR_ID is '付款行_账号'
/

comment on column CIPS_112_REMIT.DBTR_ID_SCHEX is '付款行_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AC_IBAN is '付款行账户_IBAN码'
/

comment on column CIPS_112_REMIT.DBTR_AC_ID is '付款行账户_账号'
/

comment on column CIPS_112_REMIT.DBTR_AC_ID_SCHE is '付款行账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.DBTR_AC_ID_SCHEX is '付款行账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AC_ID_ISSR is '付款行账户_发码方'
/

comment on column CIPS_112_REMIT.DBTR_AC_TYPE is '付款行账户_类型代码'
/

comment on column CIPS_112_REMIT.DBTR_AC_TYPEX is '付款行账户_用途说明'
/

comment on column CIPS_112_REMIT.DBTR_AC_CCY is '付款行账户_币种'
/

comment on column CIPS_112_REMIT.DBTR_AC_NAME is '付款行账户_名称'
/

comment on column CIPS_112_REMIT.DBTR_AC_AKA_ID_TP is '付款行账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.DBTR_AC_AKA_ID_TPX is '付款行账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AC_AKA_ID is '付款行账户_账户别名'
/

comment on column CIPS_112_REMIT.DBTR_AGT_BIC is '付款行开户行_BIC码'
/

comment on column CIPS_112_REMIT.DBTR_AGT_CLR_SYS is '付款行开户行_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_CLR_SYSX is '付款行开户行_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_CLR_SYS_MMBID is '付款行开户行_参与者身份标识'
/

comment on column CIPS_112_REMIT.DBTR_AGT_LEI is '付款行开户行_LEI码'
/

comment on column CIPS_112_REMIT.DBTR_AGT_NAME is '付款行开户行_名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_DEPT is '付款行开户行_地址_部门'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_SDEPT is '付款行开户行_地址_分部'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_STRT_NM is '付款行开户行_地址_街道名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_BLDG_NB is '付款行开户行_地址_建筑编号'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_BLDG_NM is '付款行开户行_地址_建筑名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_FLR is '付款行开户行_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_PST_BX is '付款行开户行_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_ROOM is '付款行开户行_地址_房间号'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_PST_CD is '付款行开户行_地址_邮政编码'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_TWN is '付款行开户行_地址_城镇名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_TWN_LOC is '付款行开户行_地址_城镇地址'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_DSTRCT is '付款行开户行_地址_地区名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_AREA is '付款行开户行_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_CTRY is '付款行开户行_地址_国家'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_ADR_LINE1 is '付款行开户行_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ADR_ADR_LINE2 is '付款行开户行_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ID is '付款行开户行_账号'
/

comment on column CIPS_112_REMIT.DBTR_AGT_ID_SCHEX is '付款行开户行_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_IBAN is '付款行账户_IBAN码'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_ID is '付款行账户_账号'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_ID_SCHE is '付款行账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_ID_SCHEX is '付款行账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_ID_ISSR is '付款行账户_发码方'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_TYPE is '付款行账户_类型代码'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_TYPEX is '付款行账户_用途说明'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_CCY is '付款行账户_币种'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_NAME is '付款行账户_名称'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_AKA_ID_TP is '付款行账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_AKA_ID_TPX is '付款行账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.DBTR_AGT_AC_AKA_ID is '付款行账户_账户别名'
/

comment on column CIPS_112_REMIT.CDTR_AGT_BIC is '收款行开户行_BIC码'
/

comment on column CIPS_112_REMIT.CDTR_AGT_CLR_SYS is '收款行开户行_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_CLR_SYSX is '收款行开户行_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_CLR_SYS_MMBID is '收款行开户行_参与者身份标识'
/

comment on column CIPS_112_REMIT.CDTR_AGT_LEI is '收款行开户行_LEI码'
/

comment on column CIPS_112_REMIT.CDTR_AGT_NAME is '收款行开户行_名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_DEPT is '收款行开户行_地址_部门'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_SDEPT is '收款行开户行_地址_分部'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_STRT_NM is '收款行开户行_地址_街道名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_BLDG_NB is '收款行开户行_地址_建筑编号'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_BLDG_NM is '收款行开户行_地址_建筑名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_FLR is '收款行开户行_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_PST_BX is '收款行开户行_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_ROOM is '收款行开户行_地址_房间号'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_PST_CD is '收款行开户行_地址_邮政编码'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_TWN is '收款行开户行_地址_城镇名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_TWN_LOC is '收款行开户行_地址_城镇地址'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_DSTRCT is '收款行开户行_地址_地区名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_AREA is '收款行开户行_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_CTRY is '收款行开户行_地址_国家'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_ADR_LINE1 is '收款行开户行_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ADR_ADR_LINE2 is '收款行开户行_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ID is '收款行开户行_账号'
/

comment on column CIPS_112_REMIT.CDTR_AGT_ID_SCHEX is '收款行开户行_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_IBAN is '收款行账户_IBAN码'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_ID is '收款行账户_账号'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_ID_SCHE is '收款行账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_ID_SCHEX is '收款行账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_ID_ISSR is '收款行账户_发码方'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_TYPE is '收款行账户_类型代码'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_TYPEX is '收款行账户_用途说明'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_CCY is '收款行账户_币种'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_NAME is '收款行账户_名称'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_AKA_ID_TP is '收款行账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_AKA_ID_TPX is '收款行账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AGT_AC_AKA_ID is '收款行账户_账户别名'
/

comment on column CIPS_112_REMIT.CDTR_BIC is '收款行_BIC码'
/

comment on column CIPS_112_REMIT.CDTR_CLR_SYS is '收款行_清算系统标识（代码）'
/

comment on column CIPS_112_REMIT.CDTR_CLR_SYSX is '收款行_清算系统标识（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_CLR_SYS_MMBID is '收款行_参与者身份标识'
/

comment on column CIPS_112_REMIT.CDTR_LEI is '收款行_LEI码'
/

comment on column CIPS_112_REMIT.CDTR_NAME is '收款行_名称'
/

comment on column CIPS_112_REMIT.CDTR_ADR_DEPT is '收款行_地址_部门'
/

comment on column CIPS_112_REMIT.CDTR_ADR_SDEPT is '收款行_地址_分部'
/

comment on column CIPS_112_REMIT.CDTR_ADR_STRT_NM is '收款行_地址_街道名称'
/

comment on column CIPS_112_REMIT.CDTR_ADR_BLDG_NB is '收款行_地址_建筑编号'
/

comment on column CIPS_112_REMIT.CDTR_ADR_BLDG_NM is '收款行_地址_建筑名称'
/

comment on column CIPS_112_REMIT.CDTR_ADR_FLR is '收款行_地址_建筑楼层'
/

comment on column CIPS_112_REMIT.CDTR_ADR_PST_BX is '收款行_地址_邮政信箱'
/

comment on column CIPS_112_REMIT.CDTR_ADR_ROOM is '收款行_地址_房间号'
/

comment on column CIPS_112_REMIT.CDTR_ADR_PST_CD is '收款行_地址_邮政编码'
/

comment on column CIPS_112_REMIT.CDTR_ADR_TWN is '收款行_地址_城镇名称'
/

comment on column CIPS_112_REMIT.CDTR_ADR_TWN_LOC is '收款行_地址_城镇地址'
/

comment on column CIPS_112_REMIT.CDTR_ADR_DSTRCT is '收款行_地址_地区名称'
/

comment on column CIPS_112_REMIT.CDTR_ADR_AREA is '收款行_地址_国家区域（区/洲）'
/

comment on column CIPS_112_REMIT.CDTR_ADR_CTRY is '收款行_地址_国家'
/

comment on column CIPS_112_REMIT.CDTR_ADR_ADR_LINE1 is '收款行_地址_自由格式地址1'
/

comment on column CIPS_112_REMIT.CDTR_ADR_ADR_LINE2 is '收款行_地址_自由格式地址2'
/

comment on column CIPS_112_REMIT.CDTR_ID is '收款行_账号'
/

comment on column CIPS_112_REMIT.CDTR_ID_SCHEX is '收款行_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AC_IBAN is '收款行账户_IBAN码'
/

comment on column CIPS_112_REMIT.CDTR_AC_ID is '收款行账户_账号'
/

comment on column CIPS_112_REMIT.CDTR_AC_ID_SCHE is '收款行账户_身份标识方案名称（代码）'
/

comment on column CIPS_112_REMIT.CDTR_AC_ID_SCHEX is '收款行账户_身份标识方案名称（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AC_ID_ISSR is '收款行账户_发码方'
/

comment on column CIPS_112_REMIT.CDTR_AC_TYPE is '收款行账户_类型代码'
/

comment on column CIPS_112_REMIT.CDTR_AC_TYPEX is '收款行账户_用途说明'
/

comment on column CIPS_112_REMIT.CDTR_AC_CCY is '收款行账户_币种'
/

comment on column CIPS_112_REMIT.CDTR_AC_NAME is '收款行账户_名称'
/

comment on column CIPS_112_REMIT.CDTR_AC_AKA_ID_TP is '收款行账户_账户别名类型（代码）'
/

comment on column CIPS_112_REMIT.CDTR_AC_AKA_ID_TPX is '收款行账户_账户别名类型（自定义内容）'
/

comment on column CIPS_112_REMIT.CDTR_AC_AKA_ID is '收款行账户_账户别名'
/

comment on column CIPS_112_REMIT.INSTR_FOR_CDTR_AGT1 is '至收款行开户行附言1'
/

comment on column CIPS_112_REMIT.INSTR_FOR_CDTR_AGT2 is '至收款行开户行附言2'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT1 is '至收报行的附言1'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT2 is '至收报行的附言2'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT3 is '至收报行的附言3'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT4 is '至收报行的附言4'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT5 is '至收报行的附言5'
/

comment on column CIPS_112_REMIT.INSTR_FOR_NXT_AGT6 is '至收报行的附言6'
/

comment on column CIPS_112_REMIT.PURP is '付款目的'
/

comment on column CIPS_112_REMIT.PURPX is '付款目的Proprietary'
/

comment on column CIPS_112_REMIT.RMT_INF is '附言'
/

comment on column CIPS_112_REMIT.PLC_AND_NM is 'PLC_AND_NM'
/

comment on column CIPS_112_REMIT.XPCTD_STTLM_DT is '结算时间'
/

comment on column CIPS_112_REMIT.DAY_NIGHT_FLG is '日间夜间标志'
/

comment on column CIPS_112_REMIT.RSV1 is '备用1'
/

comment on column CIPS_112_REMIT.RSV2 is '备用2'
/

comment on column CIPS_112_REMIT.RSV3 is '备用3'
/

comment on column CIPS_112_REMIT.RSV4 is '备用4'
/

comment on column CIPS_112_REMIT.RSV5 is '备用5'
/