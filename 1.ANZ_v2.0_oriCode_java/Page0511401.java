...
@ClassForNameAble
public class Page0511401 extends CommonPageView {
    ...
    // protected ViewDataset queryDs;
        ...
        public ViewDataset otxnRstDs;
        public ViewDataset otxnQryDs;
        public ViewDataset inputDs;
        public ViewDataset chrgDtlDs;

    // Command
    // protected DatasetCommand BTN_INQ_Cmd;
        protected DatasetCommand QueryTxn_Cmd;
    ...
    // protected USelectItem frmCXTJ_DSPT_RSN_CD;
        ...
        protected UDynamicForm frmQRYTXN;
            protected UTextItem frmQRYTXN_MSG_ID;
            protected UTextItem frmQRYTXN_TXN_SEQ_NO;
            protected UDateItem frmQRYTXN_WORK_DATE;
            protected UDateItem frmQRYTXN_CENTER_DATE;
            protected UMoneyItem frmQRYTXN_AMT;
    ...
    // protected UButton BTN_INQ;
        protected UButton BTN_ADD_CHARG_ITEM;
        protected UButton BTN_MOD_CHARG_ITEM;
        protected UButton BTN_DEL_CHARG_ITEM;
        protected UButton BTN_OK;
        protected UButton BTN_OTXN_QRY;
        protected UButton BTN_OTXN_CLOSE;
        protected UButton BTN_CHRG_DTL_OK;
    ...
    // protected UNavigateBar nvresultTb;
        ...
        protected UTable tbOTXN;
        protected UNavigateBar nvtbOTXN;

    // Subwindow
    // protected UWindow detailSw1;
        protected UWindow queryTxnSubWin;
        protected UWindow chrgSubWin;

        
//        protected UDynamicForm frmBCXX;
        protected USelectItem frmRTR_ACCOUNT_TYPE;
        protected UTextItem frmRTR_PAYER_ACTNO;
        protected UDateItem frmRTR_VALUE_DATE;
        protected UMoneyItem frmRTR_CHARGE_AMT;
        protected USelectItem frmRTR_C_BOP_FLAG;
        protected USelectItem frmRTR_C_RCFE_FLAG;
    ...
    protected PageViewConfig initConfig() {
        ...
        dataset.put("otxnRstDs", sub_ds_otxnRstDs());
        dataset.put("otxnQryDs", sub_ds_otxnQryDs());
        ...
        command.put("QueryTxn_Cmd", sub_cmd_QueryTxn_Cmd());
   ...
   //        BaseConfig _frmCXTJ = sub_form_frmCXTJ();
        //        _renderLayerList.add(_frmCXTJ);
            ...
            _renderLayerList.add(_frmHEAD);



            BaseConfig _frmSTAC = sub_form_frmSTAC();
            _renderLayerList.add(_frmSTAC);



            BaseConfig _frmSCENARIO = sub_form_frmSCENARIO();
            _renderLayerList.add(_frmSCENARIO);



            BaseConfig _frmORITXN = sub_form_frmORITXN();
            _renderLayerList.add(_frmORITXN);

//            BaseConfig _frmBCXX = sub_form_frmBCXX();
//            _renderLayerList.add(_frmBCXX);

            BaseConfig _frmRTR = sub_form_frmRTR();
            _renderLayerList.add(_frmRTR);

            BaseConfig _btnGroupCHRG = new BaseConfig();
            _btnGroupCHRG.setXmlTag("Layout");
            _btnGroupCHRG.put("id", "btnGroup");
            _btnGroupCHRG.put("type", "HFlow");
            _btnGroupCHRG.put("row", "");
            _btnGroupCHRG.put("column", "");
            _btnGroupCHRG.put("labelAlign", "left");
            _btnGroupCHRG.put("componentAlignment", "Top_Left");
            _btnGroupCHRG.put("margin", "true");
            _btnGroupCHRG.put("defaultLayoutAlign", "right");
            _btnGroupCHRG.put("spacing", "true");
            _btnGroupCHRG.put("columnExpandRatio", "");
            _btnGroupCHRG.put("width", "");
            _btnGroupCHRG.put("height", "");
            _btnGroupCHRG.put("enable", "true");
            _btnGroupCHRG.put("readOnly", "false");
            _btnGroupCHRG.put("visible", "true");
            List<BaseConfig> _btnGroupCHRGList = new ArrayList<BaseConfig>();
            _btnGroupCHRG.put("_btnGroupCHRGList",_btnGroupCHRGList);
                BaseConfig _BTN_ADD_CHARG_ITEM = new BaseConfig();
                _BTN_ADD_CHARG_ITEM.setXmlTag("Button");
                _BTN_ADD_CHARG_ITEM.put("id", "BTN_ADD_CHARG_ITEM");
                _BTN_ADD_CHARG_ITEM.put("type", "Base");
                _BTN_ADD_CHARG_ITEM.put("title", "添加费用信息");
                _BTN_ADD_CHARG_ITEM.put("command", "");
                _BTN_ADD_CHARG_ITEM.put("width", "");
                _BTN_ADD_CHARG_ITEM.put("height", "");
                _BTN_ADD_CHARG_ITEM.put("columnStart", "");
                _BTN_ADD_CHARG_ITEM.put("columnEnd", "");
                _BTN_ADD_CHARG_ITEM.put("rowStart", "");
                _BTN_ADD_CHARG_ITEM.put("rowEnd", "");
                _BTN_ADD_CHARG_ITEM.put("enable", "true");
                _BTN_ADD_CHARG_ITEM.put("readOnly", "false");
                _BTN_ADD_CHARG_ITEM.put("visible", "true");
                _btnGroupCHRGList.add(_BTN_ADD_CHARG_ITEM);
                BaseConfig _BTN_MOD_CHARG_ITEM = new BaseConfig();
                _BTN_MOD_CHARG_ITEM.setXmlTag("Button");
                _BTN_MOD_CHARG_ITEM.put("id", "BTN_MOD_CHARG_ITEM");
                _BTN_MOD_CHARG_ITEM.put("type", "Base");
                _BTN_MOD_CHARG_ITEM.put("title", "修改");
                _BTN_MOD_CHARG_ITEM.put("command", "");
                _BTN_MOD_CHARG_ITEM.put("width", "");
                _BTN_MOD_CHARG_ITEM.put("height", "");
                _BTN_MOD_CHARG_ITEM.put("columnStart", "");
                _BTN_MOD_CHARG_ITEM.put("columnEnd", "");
                _BTN_MOD_CHARG_ITEM.put("rowStart", "");
                _BTN_MOD_CHARG_ITEM.put("rowEnd", "");
                _BTN_MOD_CHARG_ITEM.put("enable", "true");
                _BTN_MOD_CHARG_ITEM.put("readOnly", "false");
                _BTN_MOD_CHARG_ITEM.put("visible", "true");
                _btnGroupCHRGList.add(_BTN_MOD_CHARG_ITEM);
                BaseConfig _BTN_DEL_CHARG_ITEM = new BaseConfig();
                _BTN_DEL_CHARG_ITEM.setXmlTag("Button");
                _BTN_DEL_CHARG_ITEM.put("id", "BTN_DEL_CHARG_ITEM");
                _BTN_DEL_CHARG_ITEM.put("type", "Base");
                _BTN_DEL_CHARG_ITEM.put("title", "删除");
                _BTN_DEL_CHARG_ITEM.put("command", "");
                _BTN_DEL_CHARG_ITEM.put("width", "");
                _BTN_DEL_CHARG_ITEM.put("height", "");
                _BTN_DEL_CHARG_ITEM.put("columnStart", "");
                _BTN_DEL_CHARG_ITEM.put("columnEnd", "");
                _BTN_DEL_CHARG_ITEM.put("rowStart", "");
                _BTN_DEL_CHARG_ITEM.put("rowEnd", "");
                _BTN_DEL_CHARG_ITEM.put("enable", "true");
                _BTN_DEL_CHARG_ITEM.put("readOnly", "false");
                _BTN_DEL_CHARG_ITEM.put("visible", "true");
                _btnGroupCHRGList.add(_BTN_DEL_CHARG_ITEM);
            _renderLayerList.add(_btnGroupCHRG);




            BaseConfig _tbCHRG = sub_table_tbCHRG();
                    _renderLayerList.add(_tbCHRG);
            ...
            _btnGroupBOTTOM.put("_btnGroupBOTTOMList",_btnGroupBOTTOMList);
                ...
                _btnGroupBOTTOMList.add(_BTN_OK);
            _renderLayerList.add(_btnGroupBOTTOM);


        render.put("_renderLayer", _renderLayer);

            BaseConfig _queryTxnSubWin = new BaseConfig();
                    _queryTxnSubWin.setXmlTag("Window");
                    _queryTxnSubWin.put("id", "queryTxnSubWin");
                    _queryTxnSubWin.put("fragmentId", "");
                    _queryTxnSubWin.put("type", "Sub");
                    _queryTxnSubWin.put("title", "待退汇交易查询");
                    _queryTxnSubWin.put("closeable", "true");
                    _queryTxnSubWin.put("draggable", "false");
                    _queryTxnSubWin.put("resizeable", "true");
                    _queryTxnSubWin.put("shortcut", "");
                    _queryTxnSubWin.put("modal", "true");
                    _queryTxnSubWin.put("center", "");
                    _queryTxnSubWin.put("positionX", "220");
                    _queryTxnSubWin.put("positionY", "30");
                    _queryTxnSubWin.put("border", "1");
                    _queryTxnSubWin.put("width", "65%");
                    _queryTxnSubWin.put("height", "85%");
                    _queryTxnSubWin.put("enable", "true");
                    _queryTxnSubWin.put("readOnly", "false");
                    _queryTxnSubWin.put("visible", "true");
                    List<BaseConfig> _queryTxnSubWinList = new ArrayList<BaseConfig>();
                    _queryTxnSubWin.put("_queryTxnSubWinList",_queryTxnSubWinList);
                    BaseConfig _LtqueryTxnSubWin = new BaseConfig();
                    _LtqueryTxnSubWin.setXmlTag("Layout");
                    _LtqueryTxnSubWin.put("id", "LtqueryTxnSubWin");
                    _LtqueryTxnSubWin.put("fragmentId", "");
                    _LtqueryTxnSubWin.put("type", "VFlow");
                    _LtqueryTxnSubWin.put("row", "");
                    _LtqueryTxnSubWin.put("column", "");
                    _LtqueryTxnSubWin.put("labelAlign", "top");
                    _LtqueryTxnSubWin.put("componentAlignment", "Top_Left");
                    _LtqueryTxnSubWin.put("margin", "true");
                    _LtqueryTxnSubWin.put("spacing", "true");
                    _LtqueryTxnSubWin.put("columnExpandRatio", "");
                    _LtqueryTxnSubWin.put("width", "100%");
                    _LtqueryTxnSubWin.put("height", "");
                    _LtqueryTxnSubWin.put("enable", "true");
                    _LtqueryTxnSubWin.put("readOnly", "false");
                    _LtqueryTxnSubWin.put("visible", "true");
                    List<BaseConfig> _LtqueryTxnSubWinList = new ArrayList<BaseConfig>();
                    _LtqueryTxnSubWin.put("_LtqueryTxnSubWinList",_LtqueryTxnSubWinList);

                BaseConfig _frmQRYTXN = sub_form_frmQRYTXN();
                _LtqueryTxnSubWinList.add(_frmQRYTXN);



                BaseConfig _btnGroupQRYTXN = new BaseConfig();
                _btnGroupQRYTXN.setXmlTag("Layout");
                _btnGroupQRYTXN.put("id", "btnGroup");
                _btnGroupQRYTXN.put("type", "HFlow");
                _btnGroupQRYTXN.put("row", "");
                _btnGroupQRYTXN.put("column", "");
                _btnGroupQRYTXN.put("labelAlign", "left");
                _btnGroupQRYTXN.put("componentAlignment", "Top_Left");
                _btnGroupQRYTXN.put("margin", "true");
                _btnGroupQRYTXN.put("defaultLayoutAlign", "right");
                _btnGroupQRYTXN.put("spacing", "true");
                _btnGroupQRYTXN.put("columnExpandRatio", "");
                _btnGroupQRYTXN.put("width", "");
                _btnGroupQRYTXN.put("height", "");
                _btnGroupQRYTXN.put("enable", "true");
                _btnGroupQRYTXN.put("readOnly", "false");
                _btnGroupQRYTXN.put("visible", "true");
                List<BaseConfig> _btnGroupQRYTXNList = new ArrayList<BaseConfig>();
                _btnGroupQRYTXN.put("_btnGroupQRYTXNList",_btnGroupQRYTXNList);
                    BaseConfig _BTN_OTXN_QRY = new BaseConfig();
                    _BTN_OTXN_QRY.setXmlTag("Button");
                    _BTN_OTXN_QRY.put("id", "BTN_OTXN_QRY");
                    _BTN_OTXN_QRY.put("type", "Base");
                    _BTN_OTXN_QRY.put("title", "查询");
                    _BTN_OTXN_QRY.put("command", "");
                    _BTN_OTXN_QRY.put("width", "");
                    _BTN_OTXN_QRY.put("height", "");
                    _BTN_OTXN_QRY.put("columnStart", "");
                    _BTN_OTXN_QRY.put("columnEnd", "");
                    _BTN_OTXN_QRY.put("rowStart", "");
                    _BTN_OTXN_QRY.put("rowEnd", "");
                    _BTN_OTXN_QRY.put("enable", "true");
                    _BTN_OTXN_QRY.put("readOnly", "false");
                    _BTN_OTXN_QRY.put("visible", "true");
                    _btnGroupQRYTXNList.add(_BTN_OTXN_QRY);
                    BaseConfig _BTN_OTXN_CLOSE = new BaseConfig();
                    _BTN_OTXN_CLOSE.setXmlTag("Button");
                    _BTN_OTXN_CLOSE.put("id", "BTN_OTXN_CLOSE");
                    _BTN_OTXN_CLOSE.put("type", "Base");
                    _BTN_OTXN_CLOSE.put("title", "关闭");
                    _BTN_OTXN_CLOSE.put("command", "");
                    _BTN_OTXN_CLOSE.put("width", "");
                    _BTN_OTXN_CLOSE.put("height", "");
                    _BTN_OTXN_CLOSE.put("columnStart", "");
                    _BTN_OTXN_CLOSE.put("columnEnd", "");
                    _BTN_OTXN_CLOSE.put("rowStart", "");
                    _BTN_OTXN_CLOSE.put("rowEnd", "");
                    _BTN_OTXN_CLOSE.put("enable", "true");
                    _BTN_OTXN_CLOSE.put("readOnly", "false");
                    _BTN_OTXN_CLOSE.put("visible", "true");
                    _btnGroupQRYTXNList.add(_BTN_OTXN_CLOSE);
                _LtqueryTxnSubWinList.add(_btnGroupQRYTXN);



                BaseConfig _tbOTXN = sub_table_tbOTXN();
                _LtqueryTxnSubWinList.add(_tbOTXN);
                        BaseConfig _nvtbOTXN = new BaseConfig();
                        _nvtbOTXN.setXmlTag("Navigation");
                        _nvtbOTXN.put("id", "nvtbOTXN");
                        _nvtbOTXN.put("fragmentId", "");
                        _nvtbOTXN.put("type", "Pagebar");
                        _nvtbOTXN.put("dataset", "otxnRstDs");
                        _nvtbOTXN.put("showPagesize", "");
                        _nvtbOTXN.put("showFirstAndLast", "");
                        _nvtbOTXN.put("showRefresh", "");
                        _nvtbOTXN.put("showDetail", "");
                        _nvtbOTXN.put("showTotalCount", "");
                        _nvtbOTXN.put("enable", "true");
                        _nvtbOTXN.put("readOnly", "false");
                        _nvtbOTXN.put("visible", "true");
                 _LtqueryTxnSubWinList.add(_nvtbOTXN);

            _queryTxnSubWinList.add(_LtqueryTxnSubWin);
            render.put("_queryTxnSubWin", _queryTxnSubWin);
            BaseConfig _chrgSubWin = new BaseConfig();
                ...
                _btnGroupCHRGDTL.put("_btnGroupCHRGDTLList",_btnGroupCHRGDTLList);
                    BaseConfig _BTN_CHRG_DTL_OK = new BaseConfig();
                    _BTN_CHRG_DTL_OK.setXmlTag("Button");
                    _BTN_CHRG_DTL_OK.put("id", "BTN_CHRG_DTL_OK");
                    _BTN_CHRG_DTL_OK.put("type", "Base");
                    _BTN_CHRG_DTL_OK.put("title", "确认");
                    _BTN_CHRG_DTL_OK.put("command", "");
                    _BTN_CHRG_DTL_OK.put("width", "");
                    _BTN_CHRG_DTL_OK.put("height", "");
                    _BTN_CHRG_DTL_OK.put("columnStart", "");
                    _BTN_CHRG_DTL_OK.put("columnEnd", "");
                    _BTN_CHRG_DTL_OK.put("rowStart", "");
                    _BTN_CHRG_DTL_OK.put("rowEnd", "");
                    _BTN_CHRG_DTL_OK.put("enable", "true");
                    _BTN_CHRG_DTL_OK.put("readOnly", "false");
                    _BTN_CHRG_DTL_OK.put("visible", "true");
                    _btnGroupCHRGDTLList.add(_BTN_CHRG_DTL_OK);
    ...
    // Dataset define
     ...
     private BaseConfig sub_ds_otxnRstDs(){
             BaseConfig otxnRstDs = new BaseConfig();
             List<BaseConfig> fieldsotxnRstDs = new ArrayList<BaseConfig>();

            //inputDsFieldAttrList
            List<DsFieldAttr> list = new ArrayList<>();
            list.add(new DsFieldAttr( "WORK_DATE","Base","工作日期","date","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "CENTER_DATE","Base","人行日期","date","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "TXN_SEQ_NO","Base","交易流水号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "MSG_ID","Base","报文标识号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "MSG_TYPE","Base","报文类型","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "BIZ_CATE_CODE","Base","业务种类","string","35","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "AMT","Base","交易金额","money","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_ST_BRNO","Base","付款直参","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_BRNO","Base","付款间参","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_ACCT_BRNO","Base","付款开户行行号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_ACCT_BRNAME","Base","付款开户行行名","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_ACTNO","Base","付款人账号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_NAME","Base","付款人名称","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_RES_CTRY","Base","付款人常驻国家地区代码","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_BR_BRNO","Base","付款行行号(112)","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_ST_BRNO","Base","收款直参","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_BRNO","Base","收款间参","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_ACCT_BRNO","Base","收款开户行行号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_ACCT_BRNAME","Base","收款开户行行名","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_ACTNO","Base","收款人账号","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_NAME","Base","收款人名称","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_RES_CTRY","Base","收款人常驻国家地区代码","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYEE_BR_BRNO","Base","收款行行号(112)","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "MSG_SND_TIME","Base","报文发送时间","string","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "E2E_ID","Base","端到端标识号","string","512","0","","","","false","false","right"));
            ...
            for (DsFieldAttr attr : list) {
                ...
                fieldBaseConfig.put("readOnly", attr.getReadOnly());
                fieldBaseConfig.put("msgAlign", attr.getMsgAlign());
                fieldsotxnRstDs .add(fieldBaseConfig);
           }
             otxnRstDs.put("fields", fieldsotxnRstDs);
             return otxnRstDs;
         }
     private BaseConfig sub_ds_otxnQryDs(){
             BaseConfig otxnQryDs = new BaseConfig();
             List<BaseConfig> fieldsotxnQryDs = new ArrayList<BaseConfig>();
            ...
            list.add(new DsFieldAttr( "WORK_DATE","Base","工作日期","date","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "CENTER_DATE","Base","人行日期","date","512","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "AMT","Base","金额","money","22","0","","","","false","false","right"));
            ...
            for (DsFieldAttr attr : list) {
                ...
                fieldBaseConfig.put("readOnly", attr.getReadOnly());
                fieldBaseConfig.put("msgAlign", attr.getMsgAlign());
                fieldsotxnQryDs .add(fieldBaseConfig);
           }
             otxnQryDs.put("fields", fieldsotxnQryDs);
             return otxnQryDs;
         }
     private BaseConfig sub_ds_inputDs(){
            ...
            list.add(new DsFieldAttr( "SND_BRNO","Base","","string","35","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "RCV_BRNO","Base","","string","35","0","","","","false","false","right"));

            list.add(new DsFieldAttr( "ACCOUNT_TYPE","Base","记账标志","string","1","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "PAYER_ACTNO","Base","记账账户","string","105","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "VALUE_DATE","Base","起息日","string","32","0","","","","false","false","right"));
//            list.add(new DsFieldAttr( "AMT","Base","金额","money","18","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "CHARGE_AMT","Base","手续费","money","18","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "C_BOP_FLAG","Base","BOP申报标识","string","32","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "C_RCFE_FLAG","Base","RCFE申报标识","string","32","0","","","","false","false","right"));
    ...
    private BaseConfig sub_cmd_QueryTxn_Cmd(){
            BaseConfig QueryTxn_Cmd = new BaseConfig();
            List<BaseConfig> fieldsQueryTxn_Cmd = new ArrayList<BaseConfig>();
            BaseConfig QueryTxn_Cmd_ = new BaseConfig();
            QueryTxn_Cmd_.put("id", "QueryTxn_CmdItem");
            QueryTxn_Cmd_.put("type", "Pkg");
            QueryTxn_Cmd_.put("bizType", "Query");
            QueryTxn_Cmd_.put("ref", "");
            QueryTxn_Cmd_.put("callbackFields", "");
            QueryTxn_Cmd_.put("backfillFields", "");
            QueryTxn_Cmd_.put("flushDataOnSuccess", "false");
            QueryTxn_Cmd_.put("clearOriginalData", "false");
            QueryTxn_Cmd_.put("bank", "bank");
            QueryTxn_Cmd_.put("application", "canps2");
            QueryTxn_Cmd_.put("pkgId", "GPAY_9999");
            QueryTxn_Cmd_.put("datascope", "Current");
            QueryTxn_Cmd_.put("sqlId", "");
            QueryTxn_Cmd_.put("optType", "selectList");
            QueryTxn_Cmd_.put("entityDataset", "otxnRstDs");
            QueryTxn_Cmd_.put("conditionDataset", "otxnQryDs");
            QueryTxn_Cmd_.put("validForm", "inputForm");
            QueryTxn_Cmd_.put("templateTable", "");
            QueryTxn_Cmd_.put("ifNoneResultNotification", "true");
            fieldsQueryTxn_Cmd.add(QueryTxn_Cmd_);
            QueryTxn_Cmd.put("items", fieldsQueryTxn_Cmd);
            return QueryTxn_Cmd;
        }
    private BaseConfig sub_cmd_BTN_OK_Cmd(){
            ...
            BTN_OK_Cmd_.put("pkgId", "CIPS_11401");
        ...
        // Form
         ...
         private BaseConfig sub_form_frmRTR() {
                ...
                List<FormFieldAttr> list = new ArrayList<>();
                    ...
                    list.add(new FormFieldAttr( "ACCOUNT_TYPE","记账标志","059001","1","Select","true","false","false"));
                    list.add(new FormFieldAttr( "PAYER_ACTNO","记账账户","","105","Text","true","false","false"));
                    list.add(new FormFieldAttr( "C_BOP_FLAG","BOP申报标识","059008","32","Select","true","false","false"));
                    list.add(new FormFieldAttr( "C_RCFE_FLAG","RCFE申报标识","059020","32","Select","true","false","false"));
                    list.add(new FormFieldAttr( "VALUE_DATE","起息日","","32","Date","true","false","false"));
                    ...
                    list.add(new FormFieldAttr( "CHARGE_AMT","手续费","","18","Money","true","false","false"));
...
//         
//         private BaseConfig sub_form_frmBCXX() {
//        	 BaseConfig _frmBCXX = new BaseConfig();
//             _frmBCXX.setXmlTag("Form");
//             _frmBCXX.put("id", "frmBCXX");
//             _frmBCXX.put("type", "Auto");
//             _frmBCXX.put("title", "交易补充信息");
//             _frmBCXX.put("dataset", "inputDs");
//             _frmBCXX.put("labelAlign", "left");
//             _frmBCXX.put("width", "100%");
//             _frmBCXX.put("height", "");
//             _frmBCXX.put("enable", "true");
//             _frmBCXX.put("readOnly", "false");
//             _frmBCXX.put("visible", "true");
//             _frmBCXX.put("numCols", "4");
//
//             List<BaseConfig> _frmBCXXItemList = new ArrayList<BaseConfig>();
//             
//             //fieldAttrList
//             List<FormFieldAttr> list = new ArrayList<>();
//                 list.add(new FormFieldAttr( "ACCOUNT_TYPE","记账标志","059001","1","Select","true","false","false"));
//                 list.add(new FormFieldAttr( "PAYER_ACTNO","记账账户","","105","Text","true","false","false"));
//                 list.add(new FormFieldAttr( "VALUE_DATE","起息日","","32","Date","true","false","false"));
//                 list.add(new FormFieldAttr( "AMT","金额","","18","Money","true","false","false"));
//                 list.add(new FormFieldAttr( "CHARGE_AMT","手续费","","18","Money","true","false","false"));
//                 list.add(new FormFieldAttr( "C_BOP_FLAG","BOP申报标识","059008","32","Select","true","false","false"));
//                 list.add(new FormFieldAttr( "C_RCFE_FLAG","RCFE申报标识","059020","32","Select","true","false","false"));
//
...
//                 formFieldBaseConfig = new BaseConfig();
//                 formFieldBaseConfig.setXmlTag("FormItem");
//                 formFieldBaseConfig.put("id", "frmBCXX_" + fieldId);
//
//                 switch (fieldComponentType) {
//                 case "Date":
//                     formFieldBaseConfig.put("type", "Date");
...
//
//
//                 _frmBCXXItemList.add(formFieldBaseConfig);
//                 }
//
//
//             _frmBCXX.put("formItemList",_frmBCXXItemList);
//             List<BaseConfig> _lfrmBCXX = new ArrayList<BaseConfig>();
//             _lfrmBCXX.add(_frmBCXX);
//             return _frmBCXX;
//        	 
//        	 
//         }
         ...
         private BaseConfig sub_form_frmQRYTXN() {
                BaseConfig _frmQRYTXN = new BaseConfig();
                _frmQRYTXN.setXmlTag("Form");
                _frmQRYTXN.put("id", "frmQRYTXN");
                _frmQRYTXN.put("type", "Auto");
                _frmQRYTXN.put("title", "查询条件");
                _frmQRYTXN.put("dataset", "otxnQryDs");
                _frmQRYTXN.put("labelAlign", "left");
                _frmQRYTXN.put("width", "100%");
                _frmQRYTXN.put("height", "");
                _frmQRYTXN.put("enable", "true");
                _frmQRYTXN.put("readOnly", "false");
                _frmQRYTXN.put("visible", "true");
                _frmQRYTXN.put("numCols", "4");

                List<BaseConfig> _frmQRYTXNItemList = new ArrayList<BaseConfig>();


                //fieldAttrList
                List<FormFieldAttr> list = new ArrayList<>();
                    list.add(new FormFieldAttr( "MSG_ID","报文标识号","","512","Text","true","false","false"));
                    list.add(new FormFieldAttr( "TXN_SEQ_NO","交易流水号","","512","Text","true","false","false"));
                    list.add(new FormFieldAttr( "WORK_DATE","工作日期","","512","Date","true","false","false"));
                    list.add(new FormFieldAttr( "CENTER_DATE","人行日期","","512","Date","true","false","false"));
                    list.add(new FormFieldAttr( "AMT","金额","","22","Money","true","false","false"));
                ...
                for (FormFieldAttr fieldAttr : list) {
                    ...
                    formFieldBaseConfig = new BaseConfig();
                    formFieldBaseConfig.setXmlTag("FormItem");
                    formFieldBaseConfig.put("id", "frmQRYTXN_" + fieldId);
                    ...
                    formFieldBaseConfig.put("title", fieldName);
                    formFieldBaseConfig.put("dataset", "otxnQryDs");
                    formFieldBaseConfig.put("name", fieldId);
                    formFieldBaseConfig.put("moduleid", fieldDict);
                    formFieldBaseConfig.put("bizCode", "");
                    formFieldBaseConfig.put("format", "");
                    ...
                    _frmQRYTXNItemList.add(formFieldBaseConfig);
                    }


                _frmQRYTXN.put("formItemList",_frmQRYTXNItemList);
                List<BaseConfig> _lfrmQRYTXN = new ArrayList<BaseConfig>();
                _lfrmQRYTXN.add(_frmQRYTXN);
                return _frmQRYTXN;
            }
	    ...
	    private BaseConfig sub_table_tbOTXN() {
	        BaseConfig _tbOTXN = new BaseConfig();
	        _tbOTXN.setXmlTag("Table");
	        _tbOTXN.put("id", "tbOTXN");
	        _tbOTXN.put("selectField", "");
	        _tbOTXN.put("type", "Base");
	        _tbOTXN.put("title", "");
	        _tbOTXN.put("highLight", "true");
	        _tbOTXN.put("dataset", "otxnRstDs");
	        _tbOTXN.put("width", "100%");
	        _tbOTXN.put("height", "180px");
	        _tbOTXN.put("pageLength", "10");
	        _tbOTXN.put("enable", "true");
	        _tbOTXN.put("readOnly", "false");
	        _tbOTXN.put("visible", "true");
	        _tbOTXN.put("reorderingAllowed", "true");
	        _tbOTXN.put("collapsingAllowed", "true");
	        List<BaseConfig> _tbOTXNFieldList = new ArrayList<BaseConfig>();



	        BaseConfig tbOTXN_WORK_DATE = new BaseConfig();
	        tbOTXN_WORK_DATE.setXmlTag("ListGridField");
	        tbOTXN_WORK_DATE.put("type", "Base");
	        tbOTXN_WORK_DATE.put("name", "WORK_DATE");
	        tbOTXN_WORK_DATE.put("id", "WORK_DATE");
	        tbOTXN_WORK_DATE.put("field", "WORK_DATE");
	        tbOTXN_WORK_DATE.put("title", "工作日期");
	        tbOTXN_WORK_DATE.put("bizCode", "");
	        tbOTXN_WORK_DATE.put("moduleid", "");
	        tbOTXN_WORK_DATE.put("dropdown", "");
	        tbOTXN_WORK_DATE.put("enable", "");
	        tbOTXN_WORK_DATE.put("readOnly", "");
	        tbOTXN_WORK_DATE.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_WORK_DATE);


	        BaseConfig tbOTXN_CENTER_DATE = new BaseConfig();
	        tbOTXN_CENTER_DATE.setXmlTag("ListGridField");
	        tbOTXN_CENTER_DATE.put("type", "Base");
	        tbOTXN_CENTER_DATE.put("name", "CENTER_DATE");
	        tbOTXN_CENTER_DATE.put("id", "CENTER_DATE");
	        tbOTXN_CENTER_DATE.put("field", "CENTER_DATE");
	        tbOTXN_CENTER_DATE.put("title", "人行日期");
	        tbOTXN_CENTER_DATE.put("bizCode", "");
	        tbOTXN_CENTER_DATE.put("moduleid", "");
	        tbOTXN_CENTER_DATE.put("dropdown", "");
	        tbOTXN_CENTER_DATE.put("enable", "");
	        tbOTXN_CENTER_DATE.put("readOnly", "");
	        tbOTXN_CENTER_DATE.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_CENTER_DATE);


	        BaseConfig tbOTXN_TXN_SEQ_NO = new BaseConfig();
	        tbOTXN_TXN_SEQ_NO.setXmlTag("ListGridField");
	        tbOTXN_TXN_SEQ_NO.put("type", "Base");
	        tbOTXN_TXN_SEQ_NO.put("name", "TXN_SEQ_NO");
	        tbOTXN_TXN_SEQ_NO.put("id", "TXN_SEQ_NO");
	        tbOTXN_TXN_SEQ_NO.put("field", "TXN_SEQ_NO");
	        tbOTXN_TXN_SEQ_NO.put("title", "交易流水号");
	        tbOTXN_TXN_SEQ_NO.put("bizCode", "");
	        tbOTXN_TXN_SEQ_NO.put("moduleid", "");
	        tbOTXN_TXN_SEQ_NO.put("dropdown", "");
	        tbOTXN_TXN_SEQ_NO.put("enable", "");
	        tbOTXN_TXN_SEQ_NO.put("readOnly", "");
	        tbOTXN_TXN_SEQ_NO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_TXN_SEQ_NO);


	        BaseConfig tbOTXN_MSG_ID = new BaseConfig();
	        tbOTXN_MSG_ID.setXmlTag("ListGridField");
	        tbOTXN_MSG_ID.put("type", "Base");
	        tbOTXN_MSG_ID.put("name", "MSG_ID");
	        tbOTXN_MSG_ID.put("id", "MSG_ID");
	        tbOTXN_MSG_ID.put("field", "MSG_ID");
	        tbOTXN_MSG_ID.put("title", "报文标识号");
	        tbOTXN_MSG_ID.put("bizCode", "");
	        tbOTXN_MSG_ID.put("moduleid", "");
	        tbOTXN_MSG_ID.put("dropdown", "");
	        tbOTXN_MSG_ID.put("enable", "");
	        tbOTXN_MSG_ID.put("readOnly", "");
	        tbOTXN_MSG_ID.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_MSG_ID);


	        BaseConfig tbOTXN_MSG_TYPE = new BaseConfig();
	        tbOTXN_MSG_TYPE.setXmlTag("ListGridField");
	        tbOTXN_MSG_TYPE.put("type", "Base");
	        tbOTXN_MSG_TYPE.put("name", "MSG_TYPE");
	        tbOTXN_MSG_TYPE.put("id", "MSG_TYPE");
	        tbOTXN_MSG_TYPE.put("field", "MSG_TYPE");
	        tbOTXN_MSG_TYPE.put("title", "报文类型");
	        tbOTXN_MSG_TYPE.put("bizCode", "");
	        tbOTXN_MSG_TYPE.put("moduleid", "");
	        tbOTXN_MSG_TYPE.put("dropdown", "");
	        tbOTXN_MSG_TYPE.put("enable", "");
	        tbOTXN_MSG_TYPE.put("readOnly", "");
	        tbOTXN_MSG_TYPE.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_MSG_TYPE);


	        BaseConfig tbOTXN_BIZ_CATE_CODE = new BaseConfig();
	        tbOTXN_BIZ_CATE_CODE.setXmlTag("ListGridField");
	        tbOTXN_BIZ_CATE_CODE.put("type", "Base");
	        tbOTXN_BIZ_CATE_CODE.put("name", "BIZ_CATE_CODE");
	        tbOTXN_BIZ_CATE_CODE.put("id", "BIZ_CATE_CODE");
	        tbOTXN_BIZ_CATE_CODE.put("field", "BIZ_CATE_CODE");
	        tbOTXN_BIZ_CATE_CODE.put("title", "业务种类");
	        tbOTXN_BIZ_CATE_CODE.put("bizCode", "");
	        tbOTXN_BIZ_CATE_CODE.put("moduleid", "050033");
	        tbOTXN_BIZ_CATE_CODE.put("dropdown", "");
	        tbOTXN_BIZ_CATE_CODE.put("enable", "");
	        tbOTXN_BIZ_CATE_CODE.put("readOnly", "");
	        tbOTXN_BIZ_CATE_CODE.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_BIZ_CATE_CODE);


	        BaseConfig tbOTXN_AMT = new BaseConfig();
	        tbOTXN_AMT.setXmlTag("ListGridField");
	        tbOTXN_AMT.put("type", "Base");
	        tbOTXN_AMT.put("name", "AMT");
	        tbOTXN_AMT.put("id", "AMT");
	        tbOTXN_AMT.put("field", "AMT");
	        tbOTXN_AMT.put("title", "交易金额");
	        tbOTXN_AMT.put("bizCode", "");
	        tbOTXN_AMT.put("moduleid", "");
	        tbOTXN_AMT.put("dropdown", "");
	        tbOTXN_AMT.put("enable", "");
	        tbOTXN_AMT.put("readOnly", "");
	        tbOTXN_AMT.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_AMT);


	        BaseConfig tbOTXN_PAYER_ST_BRNO = new BaseConfig();
	        tbOTXN_PAYER_ST_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYER_ST_BRNO.put("type", "Base");
	        tbOTXN_PAYER_ST_BRNO.put("name", "PAYER_ST_BRNO");
	        tbOTXN_PAYER_ST_BRNO.put("id", "PAYER_ST_BRNO");
	        tbOTXN_PAYER_ST_BRNO.put("field", "PAYER_ST_BRNO");
	        tbOTXN_PAYER_ST_BRNO.put("title", "付款直参");
	        tbOTXN_PAYER_ST_BRNO.put("bizCode", "");
	        tbOTXN_PAYER_ST_BRNO.put("moduleid", "");
	        tbOTXN_PAYER_ST_BRNO.put("dropdown", "");
	        tbOTXN_PAYER_ST_BRNO.put("enable", "");
	        tbOTXN_PAYER_ST_BRNO.put("readOnly", "");
	        tbOTXN_PAYER_ST_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_ST_BRNO);


	        BaseConfig tbOTXN_PAYER_BRNO = new BaseConfig();
	        tbOTXN_PAYER_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYER_BRNO.put("type", "Base");
	        tbOTXN_PAYER_BRNO.put("name", "PAYER_BRNO");
	        tbOTXN_PAYER_BRNO.put("id", "PAYER_BRNO");
	        tbOTXN_PAYER_BRNO.put("field", "PAYER_BRNO");
	        tbOTXN_PAYER_BRNO.put("title", "付款间参");
	        tbOTXN_PAYER_BRNO.put("bizCode", "");
	        tbOTXN_PAYER_BRNO.put("moduleid", "");
	        tbOTXN_PAYER_BRNO.put("dropdown", "");
	        tbOTXN_PAYER_BRNO.put("enable", "");
	        tbOTXN_PAYER_BRNO.put("readOnly", "");
	        tbOTXN_PAYER_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_BRNO);


	        BaseConfig tbOTXN_PAYER_ACCT_BRNO = new BaseConfig();
	        tbOTXN_PAYER_ACCT_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYER_ACCT_BRNO.put("type", "Base");
	        tbOTXN_PAYER_ACCT_BRNO.put("name", "PAYER_ACCT_BRNO");
	        tbOTXN_PAYER_ACCT_BRNO.put("id", "PAYER_ACCT_BRNO");
	        tbOTXN_PAYER_ACCT_BRNO.put("field", "PAYER_ACCT_BRNO");
	        tbOTXN_PAYER_ACCT_BRNO.put("title", "付款开户行行号");
	        tbOTXN_PAYER_ACCT_BRNO.put("bizCode", "");
	        tbOTXN_PAYER_ACCT_BRNO.put("moduleid", "");
	        tbOTXN_PAYER_ACCT_BRNO.put("dropdown", "");
	        tbOTXN_PAYER_ACCT_BRNO.put("enable", "");
	        tbOTXN_PAYER_ACCT_BRNO.put("readOnly", "");
	        tbOTXN_PAYER_ACCT_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_ACCT_BRNO);


	        BaseConfig tbOTXN_PAYER_ACCT_BRNAME = new BaseConfig();
	        tbOTXN_PAYER_ACCT_BRNAME.setXmlTag("ListGridField");
	        tbOTXN_PAYER_ACCT_BRNAME.put("type", "Base");
	        tbOTXN_PAYER_ACCT_BRNAME.put("name", "PAYER_ACCT_BRNAME");
	        tbOTXN_PAYER_ACCT_BRNAME.put("id", "PAYER_ACCT_BRNAME");
	        tbOTXN_PAYER_ACCT_BRNAME.put("field", "PAYER_ACCT_BRNAME");
	        tbOTXN_PAYER_ACCT_BRNAME.put("title", "付款开户行行名");
	        tbOTXN_PAYER_ACCT_BRNAME.put("bizCode", "");
	        tbOTXN_PAYER_ACCT_BRNAME.put("moduleid", "");
	        tbOTXN_PAYER_ACCT_BRNAME.put("dropdown", "");
	        tbOTXN_PAYER_ACCT_BRNAME.put("enable", "");
	        tbOTXN_PAYER_ACCT_BRNAME.put("readOnly", "");
	        tbOTXN_PAYER_ACCT_BRNAME.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_ACCT_BRNAME);


	        BaseConfig tbOTXN_PAYER_ACTNO = new BaseConfig();
	        tbOTXN_PAYER_ACTNO.setXmlTag("ListGridField");
	        tbOTXN_PAYER_ACTNO.put("type", "Base");
	        tbOTXN_PAYER_ACTNO.put("name", "PAYER_ACTNO");
	        tbOTXN_PAYER_ACTNO.put("id", "PAYER_ACTNO");
	        tbOTXN_PAYER_ACTNO.put("field", "PAYER_ACTNO");
	        tbOTXN_PAYER_ACTNO.put("title", "付款人账号");
	        tbOTXN_PAYER_ACTNO.put("bizCode", "");
	        tbOTXN_PAYER_ACTNO.put("moduleid", "");
	        tbOTXN_PAYER_ACTNO.put("dropdown", "");
	        tbOTXN_PAYER_ACTNO.put("enable", "");
	        tbOTXN_PAYER_ACTNO.put("readOnly", "");
	        tbOTXN_PAYER_ACTNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_ACTNO);


	        BaseConfig tbOTXN_PAYER_NAME = new BaseConfig();
	        tbOTXN_PAYER_NAME.setXmlTag("ListGridField");
	        tbOTXN_PAYER_NAME.put("type", "Base");
	        tbOTXN_PAYER_NAME.put("name", "PAYER_NAME");
	        tbOTXN_PAYER_NAME.put("id", "PAYER_NAME");
	        tbOTXN_PAYER_NAME.put("field", "PAYER_NAME");
	        tbOTXN_PAYER_NAME.put("title", "付款人名称");
	        tbOTXN_PAYER_NAME.put("bizCode", "");
	        tbOTXN_PAYER_NAME.put("moduleid", "");
	        tbOTXN_PAYER_NAME.put("dropdown", "");
	        tbOTXN_PAYER_NAME.put("enable", "");
	        tbOTXN_PAYER_NAME.put("readOnly", "");
	        tbOTXN_PAYER_NAME.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_NAME);


	        BaseConfig tbOTXN_PAYER_RES_CTRY = new BaseConfig();
	        tbOTXN_PAYER_RES_CTRY.setXmlTag("ListGridField");
	        tbOTXN_PAYER_RES_CTRY.put("type", "Base");
	        tbOTXN_PAYER_RES_CTRY.put("name", "PAYER_RES_CTRY");
	        tbOTXN_PAYER_RES_CTRY.put("id", "PAYER_RES_CTRY");
	        tbOTXN_PAYER_RES_CTRY.put("field", "PAYER_RES_CTRY");
	        tbOTXN_PAYER_RES_CTRY.put("title", "付款人常驻国家地区代码");
	        tbOTXN_PAYER_RES_CTRY.put("bizCode", "");
	        tbOTXN_PAYER_RES_CTRY.put("moduleid", "050022");
	        tbOTXN_PAYER_RES_CTRY.put("dropdown", "");
	        tbOTXN_PAYER_RES_CTRY.put("enable", "");
	        tbOTXN_PAYER_RES_CTRY.put("readOnly", "");
	        tbOTXN_PAYER_RES_CTRY.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_RES_CTRY);


	        BaseConfig tbOTXN_PAYER_BR_BRNO = new BaseConfig();
	        tbOTXN_PAYER_BR_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYER_BR_BRNO.put("type", "Base");
	        tbOTXN_PAYER_BR_BRNO.put("name", "PAYER_BR_BRNO");
	        tbOTXN_PAYER_BR_BRNO.put("id", "PAYER_BR_BRNO");
	        tbOTXN_PAYER_BR_BRNO.put("field", "PAYER_BR_BRNO");
	        tbOTXN_PAYER_BR_BRNO.put("title", "付款行行号(112)");
	        tbOTXN_PAYER_BR_BRNO.put("bizCode", "");
	        tbOTXN_PAYER_BR_BRNO.put("moduleid", "");
	        tbOTXN_PAYER_BR_BRNO.put("dropdown", "");
	        tbOTXN_PAYER_BR_BRNO.put("enable", "");
	        tbOTXN_PAYER_BR_BRNO.put("readOnly", "");
	        tbOTXN_PAYER_BR_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYER_BR_BRNO);


	        BaseConfig tbOTXN_PAYEE_ST_BRNO = new BaseConfig();
	        tbOTXN_PAYEE_ST_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_ST_BRNO.put("type", "Base");
	        tbOTXN_PAYEE_ST_BRNO.put("name", "PAYEE_ST_BRNO");
	        tbOTXN_PAYEE_ST_BRNO.put("id", "PAYEE_ST_BRNO");
	        tbOTXN_PAYEE_ST_BRNO.put("field", "PAYEE_ST_BRNO");
	        tbOTXN_PAYEE_ST_BRNO.put("title", "收款直参");
	        tbOTXN_PAYEE_ST_BRNO.put("bizCode", "");
	        tbOTXN_PAYEE_ST_BRNO.put("moduleid", "");
	        tbOTXN_PAYEE_ST_BRNO.put("dropdown", "");
	        tbOTXN_PAYEE_ST_BRNO.put("enable", "");
	        tbOTXN_PAYEE_ST_BRNO.put("readOnly", "");
	        tbOTXN_PAYEE_ST_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_ST_BRNO);


	        BaseConfig tbOTXN_PAYEE_BRNO = new BaseConfig();
	        tbOTXN_PAYEE_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_BRNO.put("type", "Base");
	        tbOTXN_PAYEE_BRNO.put("name", "PAYEE_BRNO");
	        tbOTXN_PAYEE_BRNO.put("id", "PAYEE_BRNO");
	        tbOTXN_PAYEE_BRNO.put("field", "PAYEE_BRNO");
	        tbOTXN_PAYEE_BRNO.put("title", "收款间参");
	        tbOTXN_PAYEE_BRNO.put("bizCode", "");
	        tbOTXN_PAYEE_BRNO.put("moduleid", "");
	        tbOTXN_PAYEE_BRNO.put("dropdown", "");
	        tbOTXN_PAYEE_BRNO.put("enable", "");
	        tbOTXN_PAYEE_BRNO.put("readOnly", "");
	        tbOTXN_PAYEE_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_BRNO);


	        BaseConfig tbOTXN_PAYEE_ACCT_BRNO = new BaseConfig();
	        tbOTXN_PAYEE_ACCT_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_ACCT_BRNO.put("type", "Base");
	        tbOTXN_PAYEE_ACCT_BRNO.put("name", "PAYEE_ACCT_BRNO");
	        tbOTXN_PAYEE_ACCT_BRNO.put("id", "PAYEE_ACCT_BRNO");
	        tbOTXN_PAYEE_ACCT_BRNO.put("field", "PAYEE_ACCT_BRNO");
	        tbOTXN_PAYEE_ACCT_BRNO.put("title", "收款开户行行号");
	        tbOTXN_PAYEE_ACCT_BRNO.put("bizCode", "");
	        tbOTXN_PAYEE_ACCT_BRNO.put("moduleid", "");
	        tbOTXN_PAYEE_ACCT_BRNO.put("dropdown", "");
	        tbOTXN_PAYEE_ACCT_BRNO.put("enable", "");
	        tbOTXN_PAYEE_ACCT_BRNO.put("readOnly", "");
	        tbOTXN_PAYEE_ACCT_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_ACCT_BRNO);


	        BaseConfig tbOTXN_PAYEE_ACCT_BRNAME = new BaseConfig();
	        tbOTXN_PAYEE_ACCT_BRNAME.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("type", "Base");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("name", "PAYEE_ACCT_BRNAME");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("id", "PAYEE_ACCT_BRNAME");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("field", "PAYEE_ACCT_BRNAME");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("title", "收款开户行行名");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("bizCode", "");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("moduleid", "");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("dropdown", "");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("enable", "");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("readOnly", "");
	        tbOTXN_PAYEE_ACCT_BRNAME.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_ACCT_BRNAME);


	        BaseConfig tbOTXN_PAYEE_ACTNO = new BaseConfig();
	        tbOTXN_PAYEE_ACTNO.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_ACTNO.put("type", "Base");
	        tbOTXN_PAYEE_ACTNO.put("name", "PAYEE_ACTNO");
	        tbOTXN_PAYEE_ACTNO.put("id", "PAYEE_ACTNO");
	        tbOTXN_PAYEE_ACTNO.put("field", "PAYEE_ACTNO");
	        tbOTXN_PAYEE_ACTNO.put("title", "收款人账号");
	        tbOTXN_PAYEE_ACTNO.put("bizCode", "");
	        tbOTXN_PAYEE_ACTNO.put("moduleid", "");
	        tbOTXN_PAYEE_ACTNO.put("dropdown", "");
	        tbOTXN_PAYEE_ACTNO.put("enable", "");
	        tbOTXN_PAYEE_ACTNO.put("readOnly", "");
	        tbOTXN_PAYEE_ACTNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_ACTNO);


	        BaseConfig tbOTXN_PAYEE_NAME = new BaseConfig();
	        tbOTXN_PAYEE_NAME.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_NAME.put("type", "Base");
	        tbOTXN_PAYEE_NAME.put("name", "PAYEE_NAME");
	        tbOTXN_PAYEE_NAME.put("id", "PAYEE_NAME");
	        tbOTXN_PAYEE_NAME.put("field", "PAYEE_NAME");
	        tbOTXN_PAYEE_NAME.put("title", "收款人名称");
	        tbOTXN_PAYEE_NAME.put("bizCode", "");
	        tbOTXN_PAYEE_NAME.put("moduleid", "");
	        tbOTXN_PAYEE_NAME.put("dropdown", "");
	        tbOTXN_PAYEE_NAME.put("enable", "");
	        tbOTXN_PAYEE_NAME.put("readOnly", "");
	        tbOTXN_PAYEE_NAME.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_NAME);


	        BaseConfig tbOTXN_PAYEE_RES_CTRY = new BaseConfig();
	        tbOTXN_PAYEE_RES_CTRY.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_RES_CTRY.put("type", "Base");
	        tbOTXN_PAYEE_RES_CTRY.put("name", "PAYEE_RES_CTRY");
	        tbOTXN_PAYEE_RES_CTRY.put("id", "PAYEE_RES_CTRY");
	        tbOTXN_PAYEE_RES_CTRY.put("field", "PAYEE_RES_CTRY");
	        tbOTXN_PAYEE_RES_CTRY.put("title", "收款人常驻国家地区代码");
	        tbOTXN_PAYEE_RES_CTRY.put("bizCode", "");
	        tbOTXN_PAYEE_RES_CTRY.put("moduleid", "050022");
	        tbOTXN_PAYEE_RES_CTRY.put("dropdown", "");
	        tbOTXN_PAYEE_RES_CTRY.put("enable", "");
	        tbOTXN_PAYEE_RES_CTRY.put("readOnly", "");
	        tbOTXN_PAYEE_RES_CTRY.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_RES_CTRY);


	        BaseConfig tbOTXN_PAYEE_BR_BRNO = new BaseConfig();
	        tbOTXN_PAYEE_BR_BRNO.setXmlTag("ListGridField");
	        tbOTXN_PAYEE_BR_BRNO.put("type", "Base");
	        tbOTXN_PAYEE_BR_BRNO.put("name", "PAYEE_BR_BRNO");
	        tbOTXN_PAYEE_BR_BRNO.put("id", "PAYEE_BR_BRNO");
	        tbOTXN_PAYEE_BR_BRNO.put("field", "PAYEE_BR_BRNO");
	        tbOTXN_PAYEE_BR_BRNO.put("title", "收款行行号(112)");
	        tbOTXN_PAYEE_BR_BRNO.put("bizCode", "");
	        tbOTXN_PAYEE_BR_BRNO.put("moduleid", "");
	        tbOTXN_PAYEE_BR_BRNO.put("dropdown", "");
	        tbOTXN_PAYEE_BR_BRNO.put("enable", "");
	        tbOTXN_PAYEE_BR_BRNO.put("readOnly", "");
	        tbOTXN_PAYEE_BR_BRNO.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_PAYEE_BR_BRNO);


	        BaseConfig tbOTXN_MSG_SND_TIME = new BaseConfig();
	        tbOTXN_MSG_SND_TIME.setXmlTag("ListGridField");
	        tbOTXN_MSG_SND_TIME.put("type", "Base");
	        tbOTXN_MSG_SND_TIME.put("name", "MSG_SND_TIME");
	        tbOTXN_MSG_SND_TIME.put("id", "MSG_SND_TIME");
	        tbOTXN_MSG_SND_TIME.put("field", "MSG_SND_TIME");
	        tbOTXN_MSG_SND_TIME.put("title", "报文发送时间");
	        tbOTXN_MSG_SND_TIME.put("bizCode", "");
	        tbOTXN_MSG_SND_TIME.put("moduleid", "");
	        tbOTXN_MSG_SND_TIME.put("dropdown", "");
	        tbOTXN_MSG_SND_TIME.put("enable", "");
	        tbOTXN_MSG_SND_TIME.put("readOnly", "");
	        tbOTXN_MSG_SND_TIME.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_MSG_SND_TIME);


	        BaseConfig tbOTXN_E2E_ID = new BaseConfig();
	        tbOTXN_E2E_ID.setXmlTag("ListGridField");
	        tbOTXN_E2E_ID.put("type", "Base");
	        tbOTXN_E2E_ID.put("name", "E2E_ID");
	        tbOTXN_E2E_ID.put("id", "E2E_ID");
	        tbOTXN_E2E_ID.put("field", "E2E_ID");
	        tbOTXN_E2E_ID.put("title", "端到端标识号");
	        tbOTXN_E2E_ID.put("bizCode", "");
	        tbOTXN_E2E_ID.put("moduleid", "");
	        tbOTXN_E2E_ID.put("dropdown", "");
	        tbOTXN_E2E_ID.put("enable", "");
	        tbOTXN_E2E_ID.put("readOnly", "");
	        tbOTXN_E2E_ID.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_E2E_ID);
	        
	        BaseConfig tbOTXN_C_BOP_FLAG = new BaseConfig();
	        tbOTXN_C_BOP_FLAG.setXmlTag("ListGridField");
	        tbOTXN_C_BOP_FLAG.put("type", "Base");
	        tbOTXN_C_BOP_FLAG.put("name", "C_BOP_FLAG");
	        tbOTXN_C_BOP_FLAG.put("id", "C_BOP_FLAG");
	        tbOTXN_C_BOP_FLAG.put("field", "C_BOP_FLAG");
	        tbOTXN_C_BOP_FLAG.put("title", "BOP申报标识");
	        tbOTXN_C_BOP_FLAG.put("bizCode", "");
	        tbOTXN_C_BOP_FLAG.put("moduleid", "");
	        tbOTXN_C_BOP_FLAG.put("dropdown", "");
	        tbOTXN_C_BOP_FLAG.put("enable", "");
	        tbOTXN_C_BOP_FLAG.put("readOnly", "");
	        tbOTXN_C_BOP_FLAG.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_C_BOP_FLAG);
	        
	        BaseConfig tbOTXN_C_RCFE_FLAG = new BaseConfig();
	        tbOTXN_C_RCFE_FLAG.setXmlTag("ListGridField");
	        tbOTXN_C_RCFE_FLAG.put("type", "Base");
	        tbOTXN_C_RCFE_FLAG.put("name", "C_RCFE_FLAG");
	        tbOTXN_C_RCFE_FLAG.put("id", "C_RCFE_FLAG");
	        tbOTXN_C_RCFE_FLAG.put("field", "C_RCFE_FLAG");
	        tbOTXN_C_RCFE_FLAG.put("title", "RCFE申报标识");
	        tbOTXN_C_RCFE_FLAG.put("bizCode", "");
	        tbOTXN_C_RCFE_FLAG.put("moduleid", "");
	        tbOTXN_C_RCFE_FLAG.put("dropdown", "");
	        tbOTXN_C_RCFE_FLAG.put("enable", "");
	        tbOTXN_C_RCFE_FLAG.put("readOnly", "");
	        tbOTXN_C_RCFE_FLAG.put("visible", "");
	        _tbOTXNFieldList.add(tbOTXN_C_RCFE_FLAG);


	        _tbOTXN.put("tableFieldConfigList", _tbOTXNFieldList);
	        return _tbOTXN;
	    }
    ...
    protected void afterInitControls() {
        ...
        otxnRstDs = (ViewDataset)this.getDatasets().get("otxnRstDs");
        otxnQryDs = (ViewDataset)this.getDatasets().get("otxnQryDs");
        inputDs = (ViewDataset)this.getDatasets().get("inputDs");
        chrgDtlDs = (ViewDataset)this.getDatasets().get("chrgDtlDs");

        // Command
        QueryTxn_Cmd = (DatasetCommand)this.getCommands().get("QueryTxn_Cmd");
        ...
        frmQRYTXN = (UDynamicForm)this.getControls().get("frmQRYTXN");
        frmQRYTXN_MSG_ID = (UTextItem)((UDynamicForm)this.getControls().get("frmQRYTXN")).getField("MSG_ID");
        frmQRYTXN_TXN_SEQ_NO = (UTextItem)((UDynamicForm)this.getControls().get("frmQRYTXN")).getField("TXN_SEQ_NO");
        frmQRYTXN_WORK_DATE = (UDateItem)((UDynamicForm)this.getControls().get("frmQRYTXN")).getField("WORK_DATE");
        frmQRYTXN_CENTER_DATE = (UDateItem)((UDynamicForm)this.getControls().get("frmQRYTXN")).getField("CENTER_DATE");
        frmQRYTXN_AMT = (UMoneyItem)((UDynamicForm)this.getControls().get("frmQRYTXN")).getField("AMT");
        ...
        tbOTXN = (UTable)this.getControls().get("tbOTXN");
        nvtbOTXN = (UNavigateBar)this.getControls().get("nvtbOTXN");

        // Button
        BTN_ADD_CHARG_ITEM = (UButton)this.getControls().get("BTN_ADD_CHARG_ITEM");
        BTN_MOD_CHARG_ITEM = (UButton)this.getControls().get("BTN_MOD_CHARG_ITEM");
        BTN_DEL_CHARG_ITEM = (UButton)this.getControls().get("BTN_DEL_CHARG_ITEM");
        BTN_OK = (UButton)this.getControls().get("BTN_OK");
        BTN_OTXN_QRY = (UButton)this.getControls().get("BTN_OTXN_QRY");
        BTN_OTXN_CLOSE = (UButton)this.getControls().get("BTN_OTXN_CLOSE");
        BTN_CHRG_DTL_OK = (UButton)this.getControls().get("BTN_CHRG_DTL_OK");
        BTN_CHRG_DTL_CLOSE = (UButton)this.getControls().get("BTN_CHRG_DTL_CLOSE");

        // SubWindow
        queryTxnSubWin = (UWindow)this.getControls().get("queryTxnSubWin");
        chrgSubWin = (UWindow)this.getControls().get("chrgSubWin");
        
//        frmBCXX = (UDynamicForm)this.getControls().get("frmBCXX");
        frmRTR_ACCOUNT_TYPE = (USelectItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("ACCOUNT_TYPE");
        frmRTR_PAYER_ACTNO = (UTextItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("PAYER_ACTNO");
        frmRTR_VALUE_DATE = (UDateItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("VALUE_DATE");
        frmRTR_CHARGE_AMT = (UMoneyItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("CHARGE_AMT");
        frmRTR_C_BOP_FLAG = (USelectItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("C_BOP_FLAG");
        frmRTR_C_RCFE_FLAG = (USelectItem)((UDynamicForm)this.getControls().get("frmRTR")).getField("C_RCFE_FLAG");
        return;
    }
