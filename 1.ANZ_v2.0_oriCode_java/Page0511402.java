...
import com.gingkoo.cips.client.view.Page0511401.DsFieldAttr;
import com.gingkoo.cips.client.view.Page0511401.FormFieldAttr;
...
@ClassForNameAble
public class Page0511402 extends CommonPageView {
    ...
    // protected DatasetCommand BTN_INQ_Cmd;
        ...
        protected DatasetCommand BTN_MOD_OK_Cmd;
        protected DatasetCommand BTN_MOD_CNCL_Cmd;
      //客户化
    ...
    // protected USelectItem frmCXTJ_DSPT_RSN_CD;
        protected UDynamicForm frmCXTJ;
            ...
            protected USelectItem frmCXTJ_TXN_STATUS;
        ...
        protected UDynamicForm frmJYZTXX;
            ...
            protected UTextAreaItem frmJYZTXX_BIZ_REJ_INFO;
    ...
    // protected UButton BTN_INQ;
        ...
        protected UButton BTN_MOD_OK;
        protected UButton BTN_MOD_CNCL;
        protected UButton BTN_MOD_CLOSE;
    ...
    protected PageViewConfig initConfig() {
        ...
        command.put("BTN_MOD_OK_Cmd", sub_cmd_BTN_MOD_OK_Cmd());
        command.put("BTN_MOD_CNCL_Cmd", sub_cmd_BTN_MOD_CNCL_Cmd());
      //客户化
...
//                _LtdetailSwList.add(_frmBCXX);
                ...
                _LtdetailSwList.add(_btnGroupCHRG);
                ...
                BaseConfig _frmBWJCJG = sub_form_frmBWJCJG();
                _LtdetailSwList.add(_frmBWJCJG);
                ...
                _btnGroupBOTTOM.put("_btnGroupBOTTOMList",_btnGroupBOTTOMList);
                    BaseConfig _BTN_MOD_OK = new BaseConfig();
                    _BTN_MOD_OK.setXmlTag("Button");
                    _BTN_MOD_OK.put("id", "BTN_MOD_OK");
                    _BTN_MOD_OK.put("type", "Base");
                    _BTN_MOD_OK.put("title", "修改");
                    _BTN_MOD_OK.put("command", "");
                    _BTN_MOD_OK.put("width", "");
                    _BTN_MOD_OK.put("height", "");
                    _BTN_MOD_OK.put("columnStart", "");
                    _BTN_MOD_OK.put("columnEnd", "");
                    _BTN_MOD_OK.put("rowStart", "");
                    _BTN_MOD_OK.put("rowEnd", "");
                    _BTN_MOD_OK.put("enable", "true");
                    _BTN_MOD_OK.put("readOnly", "false");
                    _BTN_MOD_OK.put("visible", "true");
                    _btnGroupBOTTOMList.add(_BTN_MOD_OK);
                    BaseConfig _BTN_MOD_CNCL = new BaseConfig();
                    _BTN_MOD_CNCL.setXmlTag("Button");
                    _BTN_MOD_CNCL.put("id", "BTN_MOD_CNCL");
                    _BTN_MOD_CNCL.put("type", "Base");
                    _BTN_MOD_CNCL.put("title", "取消");
                    _BTN_MOD_CNCL.put("command", "");
                    _BTN_MOD_CNCL.put("width", "");
                    _BTN_MOD_CNCL.put("height", "");
                    _BTN_MOD_CNCL.put("columnStart", "");
                    _BTN_MOD_CNCL.put("columnEnd", "");
                    _BTN_MOD_CNCL.put("rowStart", "");
                    _BTN_MOD_CNCL.put("rowEnd", "");
                    _BTN_MOD_CNCL.put("enable", "true");
                    _BTN_MOD_CNCL.put("readOnly", "false");
                    _BTN_MOD_CNCL.put("visible", "true");
                    _btnGroupBOTTOMList.add(_BTN_MOD_CNCL);
                    BaseConfig _BTN_MOD_CLOSE = new BaseConfig();
                    _BTN_MOD_CLOSE.setXmlTag("Button");
                    _BTN_MOD_CLOSE.put("id", "BTN_MOD_CLOSE");
                    _BTN_MOD_CLOSE.put("type", "Base");
                    _BTN_MOD_CLOSE.put("title", "关闭");
                    _BTN_MOD_CLOSE.put("command", "");
                    _BTN_MOD_CLOSE.put("width", "");
                    _BTN_MOD_CLOSE.put("height", "");
                    _BTN_MOD_CLOSE.put("columnStart", "");
                    _BTN_MOD_CLOSE.put("columnEnd", "");
                    _BTN_MOD_CLOSE.put("rowStart", "");
                    _BTN_MOD_CLOSE.put("rowEnd", "");
                    _BTN_MOD_CLOSE.put("enable", "true");
                    _BTN_MOD_CLOSE.put("readOnly", "false");
                    _BTN_MOD_CLOSE.put("visible", "true");
                    _btnGroupBOTTOMList.add(_BTN_MOD_CLOSE);
    ...
    // Dataset define
     ...
     private BaseConfig sub_ds_queryDs(){
            ...
            list.add(new DsFieldAttr( "OTXN_MSG_ID","Base","原报文标识号","string","35","0","","","","false","false","right"));
            list.add(new DsFieldAttr( "TXN_STATUS","Base","业务状态","string","","0","","","","false","false","right"));
     ...
     private BaseConfig sub_ds_inputDs(){
            ...
            list.add(new DsFieldAttr( "BIZ_REJ_INFO","Base","业务拒绝信息","string","100","0","","","","false","false","right"));
...
//            list.add(new DsFieldAttr( "AMT","Base","金额","money","18","0","","","","false","false","right"));
            ...
            list.add(new DsFieldAttr( "CHK_RESULT","Base","报文检查结果","string","512","0","","","","false","false","right"));
    ...
    private BaseConfig sub_cmd_BTN_MOD_OK_Cmd(){
            BaseConfig BTN_MOD_OK_Cmd = new BaseConfig();
            List<BaseConfig> fieldsBTN_MOD_OK_Cmd = new ArrayList<BaseConfig>();
            BaseConfig BTN_MOD_OK_Cmd_ = new BaseConfig();
            BTN_MOD_OK_Cmd_.put("id", "BTN_MOD_OK_CmdItem");
            BTN_MOD_OK_Cmd_.put("type", "Pkg");
            BTN_MOD_OK_Cmd_.put("bizType", "Commit");
            BTN_MOD_OK_Cmd_.put("ref", "");
            BTN_MOD_OK_Cmd_.put("callbackFields", "");
            BTN_MOD_OK_Cmd_.put("backfillFields", "");
            BTN_MOD_OK_Cmd_.put("flushDataOnSuccess", "false");
            BTN_MOD_OK_Cmd_.put("clearOriginalData", "false");
            BTN_MOD_OK_Cmd_.put("bank", "bank");
            BTN_MOD_OK_Cmd_.put("application", "canps2");
            BTN_MOD_OK_Cmd_.put("pkgId", "CIPS_11402");
            BTN_MOD_OK_Cmd_.put("datascope", "Current");
            BTN_MOD_OK_Cmd_.put("sqlId", "");
            BTN_MOD_OK_Cmd_.put("optType", "selectList");
            BTN_MOD_OK_Cmd_.put("entityDataset", "inputDs");
            BTN_MOD_OK_Cmd_.put("conditionDataset", "");
            BTN_MOD_OK_Cmd_.put("validForm", "inputForm");
            BTN_MOD_OK_Cmd_.put("templateTable", "");
            BTN_MOD_OK_Cmd_.put("ifNoneResultNotification", "true");
            fieldsBTN_MOD_OK_Cmd.add(BTN_MOD_OK_Cmd_);
            BTN_MOD_OK_Cmd.put("items", fieldsBTN_MOD_OK_Cmd);
            return BTN_MOD_OK_Cmd;
        }
    private BaseConfig sub_cmd_BTN_MOD_CNCL_Cmd(){
            BaseConfig BTN_MOD_CNCL_Cmd = new BaseConfig();
            List<BaseConfig> fieldsBTN_MOD_CNCL_Cmd = new ArrayList<BaseConfig>();
            BaseConfig BTN_MOD_CNCL_Cmd_ = new BaseConfig();
            BTN_MOD_CNCL_Cmd_.put("id", "BTN_MOD_CNCL_CmdItem");
            BTN_MOD_CNCL_Cmd_.put("type", "Pkg");
            BTN_MOD_CNCL_Cmd_.put("bizType", "Commit");
            BTN_MOD_CNCL_Cmd_.put("ref", "");
            BTN_MOD_CNCL_Cmd_.put("callbackFields", "");
            BTN_MOD_CNCL_Cmd_.put("backfillFields", "");
            BTN_MOD_CNCL_Cmd_.put("flushDataOnSuccess", "false");
            BTN_MOD_CNCL_Cmd_.put("clearOriginalData", "false");
            BTN_MOD_CNCL_Cmd_.put("bank", "bank");
            BTN_MOD_CNCL_Cmd_.put("application", "canps2");
            BTN_MOD_CNCL_Cmd_.put("pkgId", "CIPS_CNCL");
            BTN_MOD_CNCL_Cmd_.put("datascope", "Current");
            BTN_MOD_CNCL_Cmd_.put("sqlId", "");
            BTN_MOD_CNCL_Cmd_.put("optType", "selectList");
            BTN_MOD_CNCL_Cmd_.put("entityDataset", "inputDs");
            BTN_MOD_CNCL_Cmd_.put("conditionDataset", "");
            BTN_MOD_CNCL_Cmd_.put("validForm", "inputForm");
            BTN_MOD_CNCL_Cmd_.put("templateTable", "");
            BTN_MOD_CNCL_Cmd_.put("ifNoneResultNotification", "true");
            fieldsBTN_MOD_CNCL_Cmd.add(BTN_MOD_CNCL_Cmd_);
            BTN_MOD_CNCL_Cmd.put("items", fieldsBTN_MOD_CNCL_Cmd);
            return BTN_MOD_CNCL_Cmd;
        }
  //客户化
        ...
        // Form
         ...
         private BaseConfig sub_form_frmCXTJ() {
                ...
                List<FormFieldAttr> list = new ArrayList<>();
                    ...
                    list.add(new FormFieldAttr( "TXN_STATUS","业务状态","900218","","Select","true","false","false"));
...
//         }
         ...
         private BaseConfig sub_form_frmJYZTXX() {
                ...
                List<FormFieldAttr> list = new ArrayList<>();
                    ...
                    list.add(new FormFieldAttr( "BIZ_REJ_INFO","业务拒绝信息","","100","TextArea","true","false","false"));
         ...
         private BaseConfig sub_form_frmQXXX() {
                ...
                for (FormFieldAttr fieldAttr : list) {
                    ...
                    formFieldBaseConfig = new BaseConfig();
                    formFieldBaseConfig.setXmlTag("FormItem");
                    formFieldBaseConfig.put("id", "frmQXXX_" + fieldId);
                    ...
                    _frmQXXXItemList.add(formFieldBaseConfig);
                    }
	    ...
	    private BaseConfig sub_form_frmBWJCJG() {
	        BaseConfig _frmBWJCJG = new BaseConfig();
	        _frmBWJCJG.setXmlTag("Form");
	        _frmBWJCJG.put("id", "frmBWJCJG");
	        _frmBWJCJG.put("type", "Auto");
	        _frmBWJCJG.put("title", "报文检查结果");
	        _frmBWJCJG.put("dataset", "inputDs");
	        _frmBWJCJG.put("labelAlign", "left");
	        _frmBWJCJG.put("width", "100%");
	        _frmBWJCJG.put("height", "");
	        _frmBWJCJG.put("enable", "true");
	        _frmBWJCJG.put("readOnly", "false");
	        _frmBWJCJG.put("visible", "true");
	        _frmBWJCJG.put("numCols", "4");
	        List<BaseConfig> _frmBWJCJGItemList = new ArrayList<BaseConfig>();
	        BaseConfig _frmBWJCJG_frmBWJCJG_CHK_RESULT = new BaseConfig();
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.setXmlTag("FormItem");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("colSpan", "2");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("id", "frmBWJCJG_CHK_RESULT");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("type", "TextArea");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("title", "报文检查结果");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("dataset", "inputDs");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("name", "CHK_RESULT");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("moduleid", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("bizCode", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("format", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("required", "false");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("length", "512");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("columnStart", "4");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("columnEnd", "12");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("rowStart", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("rowEnd", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("width", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("height", "");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("enable", "true");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("readOnly", "true");
	        _frmBWJCJG_frmBWJCJG_CHK_RESULT.put("visible", "true");
	        _frmBWJCJGItemList.add(_frmBWJCJG_frmBWJCJG_CHK_RESULT);
	        _frmBWJCJG.put("formItemList",_frmBWJCJGItemList);
	        List<BaseConfig> _lfrmBWJCJG = new ArrayList<BaseConfig>();
	        _lfrmBWJCJG.add(_frmBWJCJG);
	        return _frmBWJCJG;
	    }
    ...
    protected void afterInitControls() {
        ...
        BTN_MOD_OK_Cmd = (DatasetCommand)this.getCommands().get("BTN_MOD_OK_Cmd");
        BTN_MOD_CNCL_Cmd = (DatasetCommand)this.getCommands().get("BTN_MOD_CNCL_Cmd");
      //客户化
        ...
        frmCXTJ_TXN_STATUS = (USelectItem)((UDynamicForm)this.getControls().get("frmCXTJ")).getField("TXN_STATUS");
        ...
        frmJYZTXX_BIZ_REJ_INFO = (UTextAreaItem)((UDynamicForm)this.getControls().get("frmJYZTXX")).getField("BIZ_REJ_INFO");
        ...
        BTN_MOD_OK = (UButton)this.getControls().get("BTN_MOD_OK");
        BTN_MOD_CNCL = (UButton)this.getControls().get("BTN_MOD_CNCL");
        BTN_MOD_CLOSE = (UButton)this.getControls().get("BTN_MOD_CLOSE");
