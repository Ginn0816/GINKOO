...
@ClassForNameAble
public class Page0511403 extends CommonPageView {
...
//                _LtdetailSwList.add(_frmBCXX);
    ...
    // Dataset define
     ...
     private BaseConfig sub_ds_inputDs(){
            ...
            list.add(new DsFieldAttr( "CHK_RESULT","Base","报文检查结果","string","32","0","","","","false","false","right"));
    ...
    private BaseConfig sub_cmd_BTN_SUB_OK_Cmd(){
            ...
            BTN_SUB_OK_Cmd_.put("pkgId", "CIPS_CHK");
