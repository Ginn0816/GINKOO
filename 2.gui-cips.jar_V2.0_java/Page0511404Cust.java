...
public class Page0511404Cust extends Page0511404 {
    ...
    protected void beforeRender() {
        CIPS114Common.settingBeforeRender(this, PageTypeEnum.APPROVE);
    ...
    protected void bindEvent() {
        ...
        BTN_INQ_Listener = new ClickListener() {
            ...
            public void onClick(ClickEvent event) {
                ...
                BTN_INQ_Cmd.setQuerySqlid("051140401");
            ...
            public void onRecordClick(RecordDoubleClickEvent event) {
                ...
                SUBWINDOW_Cmd.execute(new CommandCallback() {
                    ...
                    public void onCallback(boolean status, Callback callback,String commandItemName) {
                        ...
                        CIPS114Common.settingBeforeShowInSubWindow(page, PageTypeEnum.APPROVE);
                        detailSw.show();
                    }
                });
            }
        ...
        BTN_SUB_OK_Listener = new ClickListener() {
            @Override
            public void onClick(ClickEvent event) {
            	BTN_SUB_OK_Cmd.setHead("SRV_ID", "CIPS_11404");
                ...
                BTN_SUB_OK_Cmd.execute(new CommandCallback() {
                     ...
                     public void onCallback(boolean status, Callback callback,String commandItemName) {
                         ...
                         if (status) {
                             ...
                             SC.say("审核失败,错误信息"+callback.getErrorMessage());
                         }
                     }
                 });
            }
						...
						public void execute(Boolean value) {
							if (value != null && value) {			
								 BTN_SUB_REJ_Cmd.setHead("SRV_ID", "CIPS_11406");
					                inputDs.setCurrentValue("REJ_TYPE", "2");
